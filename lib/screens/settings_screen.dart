      ...
      body: SafeArea(
        child: PopScope(
          ...
          onPopInvokedWithResult: (didPop, result) {
            ...
            if (_lastLinkReturn != null && now.difference(_lastLinkReturn!) < const Duration(milliseconds: 600)) {
          ...
          Card(
            ...
            child: SwitchListTile(
              ...
              if (v) {
                ...
                if (!enabled) {
                  _showSnack('Enable notifications to run foreground service');
            ...
            child: Column(
              children: [
                ListTile(
                  ...
                  onTap: () => _openExternal('https://greengains.eremat.org/terms-of-service'),
                ),
                const Divider(height: 1),
                ListTile(
                  leading: const Icon(Icons.privacy_tip_outlined),
                  title: const Text('Privacy Policy'),
                  onTap: () => _openExternal('https://greengains.eremat.org/privacy-policy'),
                ),
                const Divider(height: 1),
                ListTile(
                  leading: const Icon(Icons.info_outline),
                  title: const Text('Open source licenses'),
                  onTap: () => showAboutDialog(context: context, applicationName: 'GreenGains'),
                ),
                const Divider(height: 1),
                ListTile(
                  leading: const Icon(Icons.delete_outline),
                  title: const Text('Data deletion request'),
                  onTap: () => _openExternal('https://greengains.eremat.org/data-deletion-request'),
                ),
              ],
            ),
          ),
