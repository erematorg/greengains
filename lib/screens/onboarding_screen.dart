      ...
      body: SafeArea(
        child: LayoutBuilder(
          builder: (context, constraints) {
            ...
            final double heroH =
                (constraints.maxHeight * 0.38).clamp(AppTheme.onboardingHeroMin, AppTheme.onboardingHeroMax).toDouble();
            final double iconSize = (heroH * AppTheme.onboardingHeroIconRatio).clamp(110.0, 160.0).toDouble();
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    FilledButton(
                      ...
                      child: Text(_busy ? 'Please wait...' : 'Create an account'),
                    ),
