...
public final class SynchronousKt$synchronous$1$migrate$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i3 == 0) {
            ...
            Function1 r11 = sqlSchema.migrate(sqlDriver, j2, j3, (AfterVersion[]) Arrays.copyOf(afterVersionArr, afterVersionArr.length)).m8086unboximpl();
            this.label = 1;
            if (QueryResult.AsyncValue.m8078awaitimpl(r11, this) == coroutine_suspended) {
