...
@DebugMetadata(c = "app.cash.sqldelight.coroutines.FlowQuery$mapToOneOrDefault$1$1", f = "FlowExtensions.kt", i = {}, l = {68}, m = "invokeSuspend", n = {}, s = {})
public final class FlowQuery$mapToOneOrDefault$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
    final /* synthetic */ T $defaultValue;
    final /* synthetic */ Query<T> $it;
    int label;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public FlowQuery$mapToOneOrDefault$1$1(Query<? extends T> query, T t2, Continuation<? super FlowQuery$mapToOneOrDefault$1$1> continuation) {
