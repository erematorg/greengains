...
class MediaSessionCompatApi24 {
    ...
    public static String getCallingPackage(Object obj) {
        ...
        try {
            return (String) mediaSession.getClass().getMethod("getCallingPackage", (Class[]) null).invoke(mediaSession, (Object[]) null);
        } catch (IllegalAccessException | NoSuchMethodException | InvocationTargetException e3) {
            Log.e(TAG, "Cannot execute MediaSession.getCallingPackage()", e3);
            return null;
        }
    }
}
