...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final class Builder {
        ...
        public Builder addCustomAction(String str, String str2, int i3) {
            return addCustomAction(new CustomAction(str, str2, i3, (Bundle) null));
        }
        ...
        public Builder setState(int i3, long j2, float f2) {
            return setState(i3, j2, f2, SystemClock.elapsedRealtime());
        }
        ...
        public Builder setState(int i3, long j2, float f2, long j3) {
            this.mState = i3;
            this.mPosition = j2;
            this.mUpdateTime = j3;
            this.mRate = f2;
    ...
    public PlaybackStateCompat(int i3, long j2, long j3, float f2, long j4, int i4, CharSequence charSequence, long j5, List<CustomAction> list, long j6, Bundle bundle) {
        this.mState = i3;
        this.mPosition = j2;
    ...
    public long getCurrentPosition(Long l2) {
        return Math.max(0, this.mPosition + ((long) (this.mSpeed * ((float) (l2 != null ? l2.longValue() : SystemClock.elapsedRealtime() - this.mUpdateTime)))));
    }
    ...
    public String toString() {
        ...
        return a.k(this.mActiveItemId, StringSubstitutor.DEFAULT_VAR_END, sb);
    }
