        ...
        public void onReceiveResult(int i3, Bundle bundle) {
            if (this.mCallback != null) {
                ...
                if (i3 == -1) {
                    ...
                    StringBuilder o3 = a.o(i3, "Unknown result code: ", " (extras=");
                    o3.append(this.mExtras);
                    o3.append(", resultData=");
                    o3.append(bundle);
                    o3.append(")");
                    Log.w(MediaBrowserCompat.TAG, o3.toString());
                } else {
        ...
        public void search(@NonNull final String str, final Bundle bundle, @NonNull final SearchCallback searchCallback) {
            if (!isConnected()) {
                ...
                try {
                    ...
                    Log.i(MediaBrowserCompat.TAG, "Remote error searching items with query: " + str, e3);
                    this.mHandler.post(new Runnable() {
                        public void run() {
                            searchCallback.onError(str, bundle);
                        }
        ...
        public void sendCustomAction(@NonNull final String str, final Bundle bundle, @Nullable final CustomActionCallback customActionCallback) {
            if (isConnected()) {
                ...
                try {
                    ...
                    Log.i(MediaBrowserCompat.TAG, "Remote error sending a custom action: action=" + str + ", extras=" + bundle, e3);
                    if (customActionCallback != null) {
                        this.mHandler.post(new Runnable() {
                            public void run() {
                                customActionCallback.onError(str, bundle, (Bundle) null);
    ...
    public static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        public class MediaServiceConnection implements ServiceConnection {
            ...
            public boolean isCurrent(String str) {
                ...
                int i4 = mediaBrowserImplBase.mState;
                if (i4 == 0 || i4 == 1) {
                    return false;
                }
                StringBuilder q2 = a.q(str, " for ");
                q2.append(MediaBrowserImplBase.this.mServiceComponent);
                q2.append(" with mServiceConnection=");
                q2.append(MediaBrowserImplBase.this.mServiceConnection);
                q2.append(" this=");
                q2.append(this);
                Log.i(MediaBrowserCompat.TAG, q2.toString());
                return false;
            }
        ...
        private static String getStateLabel(int i3) {
            return i3 != 0 ? i3 != 1 ? i3 != 2 ? i3 != 3 ? i3 != 4 ? a.k("UNKNOWN/", i3) : "CONNECT_STATE_SUSPENDED" : "CONNECT_STATE_CONNECTED" : "CONNECT_STATE_CONNECTING" : "CONNECT_STATE_DISCONNECTED" : "CONNECT_STATE_DISCONNECTING";
        }
        ...
        private boolean isCurrent(Messenger messenger, String str) {
            ...
            StringBuilder q2 = a.q(str, " for ");
            q2.append(this.mServiceComponent);
            q2.append(" with mCallbacksMessenger=");
            q2.append(this.mCallbacksMessenger);
            q2.append(" this=");
            q2.append(this);
            Log.i(MediaBrowserCompat.TAG, q2.toString());
            return false;
        ...
        public void connect() {
            ...
            throw new IllegalStateException(a.n(new StringBuilder("connect() called while neigther disconnecting nor disconnected (state="), getStateLabel(this.mState), ")"));
        }
        ...
        public Bundle getExtras() {
            ...
            throw new IllegalStateException(a.n(new StringBuilder("getExtras() called while not connected (state="), getStateLabel(this.mState), ")"));
        }
        ...
        public String getRoot() {
            ...
            throw new IllegalStateException(a.n(new StringBuilder("getRoot() called while not connected(state="), getStateLabel(this.mState), ")"));
        }
        ...
        public ComponentName getServiceComponent() {
            ...
            throw new IllegalStateException(a.m(new StringBuilder("getServiceComponent() called while not connected (state="), ")", this.mState));
        }
        ...
        public MediaSessionCompat.Token getSessionToken() {
            ...
            throw new IllegalStateException(a.m(new StringBuilder("getSessionToken() called while not connected(state="), ")", this.mState));
        }
                ...
                try {
                    for (Map.Entry next : this.mSubscriptions.entrySet()) {
                        ...
                        for (int i3 = 0; i3 < callbacks.size(); i3++) {
                            this.mServiceBinderWrapper.addSubscription(str2, callbacks.get(i3).mToken, optionsList.get(i3), this.mCallbacksMessenger);
                        }
                    }
                } catch (RemoteException unused) {
        ...
        public void search(@NonNull final String str, final Bundle bundle, @NonNull final SearchCallback searchCallback) {
            if (isConnected()) {
                ...
                throw new IllegalStateException(a.n(new StringBuilder("search() called while not connected (state="), getStateLabel(this.mState), ")"));
            }
        }
