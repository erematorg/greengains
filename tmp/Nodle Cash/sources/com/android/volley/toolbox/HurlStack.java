...
public class HurlStack extends BaseHttpStack {
    ...
    private static boolean hasResponseBody(int i3, int i4) {
    ...
    public OutputStream createOutputStream(Request<?> request, HttpURLConnection httpURLConnection, int i3) throws IOException {
    ...
    public HttpResponse executeRequest(Request<?> request, Map<String, String> map) throws IOException, AuthFailureError {
        ...
        if (urlRewriter != null) {
            ...
            if (rewriteUrl != null) {
                ...
                throw new IOException(c.a("URL blocked by rewriter: ", url));
            }
        }
    ...
    public void setConnectionParametersForRequest(HttpURLConnection httpURLConnection, Request<?> request) throws IOException, AuthFailureError {
        switch (request.getMethod()) {
            ...
            case 5:
                ...
                return;
            case 6:
                httpURLConnection.setRequestMethod(EventType.TRACK);
                return;
            case 7:
