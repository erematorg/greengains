...
final class JsonUtf8Reader extends JsonReader {
    ...
    private int nextNonWhitespace(boolean r7) throws java.io.IOException {
        ...
        L_0x006b:
            ...
            com.squareup.moshi.JsonEncodingException r6 = r6.syntaxError(r7)
            throw r6
        L_0x0072:
            r1 = 35
    ...
    private int peekKeyword() throws IOException {
        ...
        while (i4 < length) {
            int i5 = i4 + 1;
            if (!this.source.request((long) i5)) {
                return 0;
            }
            byte b4 = this.buffer.getByte((long) i4);
            if (b4 != str2.charAt(i4) && b4 != str.charAt(i4)) {
                return 0;
            }
            i4 = i5;
        }
    ...
    private int peekNumber() throws IOException {
        ...
        while (true) {
            ...
            b3 = this.buffer.getByte((long) i3);
            if (b3 == 43) {
                c3 = 6;
                if (c4 != 5) {
                    return 0;
                }
            } else if (b3 != 69 && b3 != 101) {
                if (b3 == 45) {
                    c3 = 6;
                    if (c4 == 0) {
                        c4 = 1;
                    ...
                    if (b3 >= 48 && b3 <= 57) {
                        if (c4 == z2 || c4 == 0) {
                            j2 = (long) (-(b3 + MessagePack.Code.INT8));
                            c4 = 2;
                        } else if (c4 == 2) {
                            if (j2 == 0) {
                                return 0;
                            }
                            long j3 = (10 * j2) - ((long) (b3 + MessagePack.Code.INT8));
        ...
        if (c4 == 2 && z4 && ((j2 != Long.MIN_VALUE || z3) && (j2 != 0 || !z3))) {
            if (!z3) {
                j2 = -j2;
            }
            this.peekedLong = j2;
    ...
    private boolean skipToEndOfBlockComment() throws IOException {
        ...
        Buffer buffer2 = this.buffer;
        buffer2.skip(z2 ? indexOf + ((long) byteString.size()) : buffer2.size());
        return z2;
    }
    ...
    public int nextInt() throws IOException {
        ...
        if (i3 == 17) {
            ...
            String nextQuotedValue = i3 == 9 ? nextQuotedValue(DOUBLE_QUOTE_OR_SLASH) : nextQuotedValue(SINGLE_QUOTE_OR_SLASH);
    ...
    public okio.BufferedSource nextSource() throws java.io.IOException {
        ...
        L_0x006a:
            ...
            r3.value((java.lang.String) r0)     // Catch:{ all -> 0x007d }
            r3.close()
            goto L_0x0033
        L_0x007d:
            r9 = move-exception
        ...
        L_0x00c6:
            ...
            r9.valueSource = r3
            r9.pushScope(r4)
            com.squareup.moshi.JsonValueSource r9 = r9.valueSource
    ...
    public void skipValue() throws IOException {
        if (!this.failOnUnknown) {
            ...
            int i6 = i5 - 1;
            iArr[i6] = iArr[i6] + 1;
            this.pathNames[i5 - 1] = AbstractJsonLexerKt.NULL;
            return;
        }
        throw new JsonDataException("Cannot skip unexpected " + peek() + " at " + getPath());
    }
