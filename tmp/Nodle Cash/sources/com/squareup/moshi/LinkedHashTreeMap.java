...
final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private void rebalance(Node<K, V> node, boolean z2) {
        while (node != null) {
            ...
            if (i6 == -2) {
                ...
                int i7 = node5 != null ? node5.height : 0;
                if (node4 != null) {
                    i3 = node4.height;
                }
                int i8 = i3 - i7;
                ...
                int i9 = node7 != null ? node7.height : 0;
                if (node6 != null) {
                    i3 = node6.height;
                }
                int i10 = i3 - i9;
    ...
    private void replaceInParent(Node<K, V> node, Node<K, V> node2) {
        ...
        if (node3 == null) {
            ...
            nodeArr[i3 & (nodeArr.length - 1)] = node2;
    ...
    public Node<K, V> find(K k2, boolean z2) {
        ...
        if (node2 != null) {
            ...
            while (true) {
                i3 = comparable != null ? comparable.compareTo(node2.key) : comparator2.compare(k2, node2.key);
                if (i3 == 0) {
                    return node2;
                }
    ...
    public static final class Node<K, V> implements Map.Entry<K, V> {
        ...
        public Node(Node<K, V> node, K k2, int i3, Node<K, V> node2, Node<K, V> node3) {
            this.parent = node;
            this.key = k2;
            this.hash = i3;
            this.height = 1;
