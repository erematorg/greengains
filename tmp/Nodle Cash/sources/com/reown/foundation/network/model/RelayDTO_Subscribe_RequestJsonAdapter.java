...
@Metadata(d1 = {"\u0000J\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0004¢\u0006\u0004\b\u0005\u0010\u0006J\b\u0010\u0011\u001a\u00020\fH\u0016J\u0010\u0010\u0012\u001a\u00020\u00022\u0006\u0010\u0013\u001a\u00020\u0014H\u0016J\u001a\u0010\u0015\u001a\u00020\u00162\u0006\u0010\u0017\u001a\u00020\u00182\b\u0010\u0019\u001a\u0004\u0018\u00010\u0002H\u0016R\u000e\u0010\u0007\u001a\u00020\bX\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\t\u001a\b\u0012\u0004\u0012\u00020\n0\u0001X\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u000b\u001a\b\u0012\u0004\u0012\u00020\f0\u0001X\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\r\u001a\b\u0012\u0004\u0012\u00020\u000e0\u0001X\u0004¢\u0006\u0002\n\u0000R\u0016\u0010\u000f\u001a\n\u0012\u0004\u0012\u00020\u0002\u0018\u00010\u0010X\u000e¢\u0006\u0002\n\u0000¨\u0006\u001a"}, d2 = {"Lcom/reown/foundation/network/model/RelayDTO_Subscribe_RequestJsonAdapter;", "Lcom/squareup/moshi/JsonAdapter;", "Lcom/reown/foundation/network/model/RelayDTO$Subscribe$Request;", "moshi", "Lcom/squareup/moshi/Moshi;", "<init>", "(Lcom/squareup/moshi/Moshi;)V", "options", "Lcom/squareup/moshi/JsonReader$Options;", "longAdapter", "", "stringAdapter", "", "paramsAdapter", "Lcom/reown/foundation/network/model/RelayDTO$Subscribe$Request$Params;", "constructorRef", "Ljava/lang/reflect/Constructor;", "toString", "fromJson", "reader", "Lcom/squareup/moshi/JsonReader;", "toJson", "", "writer", "Lcom/squareup/moshi/JsonWriter;", "value_", "foundation"}, k = 1, mv = {2, 2, 0}, xi = 48)
public final class RelayDTO_Subscribe_RequestJsonAdapter extends JsonAdapter<RelayDTO.Subscribe.Request> {
    @Nullable
    private volatile Constructor<RelayDTO.Subscribe.Request> constructorRef;
    @NotNull
    private final JsonAdapter<Long> longAdapter;
    @NotNull
    private final JsonReader.Options options;
    @NotNull
    private final JsonAdapter<RelayDTO.Subscribe.Request.Params> paramsAdapter;
    @NotNull
    ...
    public RelayDTO_Subscribe_RequestJsonAdapter(@NotNull Moshi moshi) {
        ...
        this.paramsAdapter = a.h(moshi, RelayDTO.Subscribe.Request.Params.class, "params", "adapter(...)");
    }

    @NotNull
    public String toString() {
        return a.j(48, "GeneratedJsonAdapter(RelayDTO.Subscribe.Request)");
    }

    @NotNull
    public RelayDTO.Subscribe.Request fromJson(@NotNull JsonReader jsonReader) {
        ...
        if (constructor == null) {
            constructor = RelayDTO.Subscribe.Request.class.getDeclaredConstructor(new Class[]{Long.TYPE, String.class, String.class, RelayDTO.Subscribe.Request.Params.class, Integer.TYPE, Util.DEFAULT_CONSTRUCTOR_MARKER});
            this.constructorRef = constructor;
            Intrinsics.checkNotNullExpressionValue(constructor, "also(...)");
        }
        if (params != null) {
            RelayDTO.Subscribe.Request newInstance = constructor.newInstance(new Object[]{l2, str, str2, params, Integer.valueOf(i3), null});
    ...
    public void toJson(@NotNull JsonWriter jsonWriter, @Nullable RelayDTO.Subscribe.Request request) {
