...
public final class RelayDTO_Unsubscribe_Result_JsonRpcErrorJsonAdapter extends JsonAdapter<RelayDTO.Unsubscribe.Result.JsonRpcError> {
    ...
    public RelayDTO_Unsubscribe_Result_JsonRpcErrorJsonAdapter(@NotNull Moshi moshi) {
    ...
    public String toString() {
        return a.j(62, "GeneratedJsonAdapter(RelayDTO.Unsubscribe.Result.JsonRpcError)");
    }

    @NotNull
    public RelayDTO.Unsubscribe.Result.JsonRpcError fromJson(@NotNull JsonReader jsonReader) {
        ...
        if (i3 == -2) {
            ...
            if (error == null) {
                ...
                return new RelayDTO.Unsubscribe.Result.JsonRpcError(str, error, l2.longValue());
            } else {
            ...
            if (constructor == null) {
                constructor = RelayDTO.Unsubscribe.Result.JsonRpcError.class.getDeclaredConstructor(new Class[]{String.class, RelayDTO.Error.class, Long.TYPE, Integer.TYPE, Util.DEFAULT_CONSTRUCTOR_MARKER});
            ...
            if (error == null) {
                ...
                RelayDTO.Unsubscribe.Result.JsonRpcError newInstance = constructor.newInstance(new Object[]{str, error, l2, Integer.valueOf(i3), null});
    ...
    public void toJson(@NotNull JsonWriter jsonWriter, @Nullable RelayDTO.Unsubscribe.Result.JsonRpcError jsonRpcError) {
