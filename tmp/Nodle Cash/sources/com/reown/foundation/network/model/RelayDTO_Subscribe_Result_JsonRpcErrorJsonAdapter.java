...
@Metadata(d1 = {"\u0000J\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0004¢\u0006\u0004\b\u0005\u0010\u0006J\b\u0010\u0011\u001a\u00020\nH\u0016J\u0010\u0010\u0012\u001a\u00020\u00022\u0006\u0010\u0013\u001a\u00020\u0014H\u0016J\u001a\u0010\u0015\u001a\u00020\u00162\u0006\u0010\u0017\u001a\u00020\u00182\b\u0010\u0019\u001a\u0004\u0018\u00010\u0002H\u0016R\u000e\u0010\u0007\u001a\u00020\bX\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\t\u001a\b\u0012\u0004\u0012\u00020\n0\u0001X\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u000b\u001a\b\u0012\u0004\u0012\u00020\f0\u0001X\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\r\u001a\b\u0012\u0004\u0012\u00020\u000e0\u0001X\u0004¢\u0006\u0002\n\u0000R\u0016\u0010\u000f\u001a\n\u0012\u0004\u0012\u00020\u0002\u0018\u00010\u0010X\u000e¢\u0006\u0002\n\u0000¨\u0006\u001a"}, d2 = {"Lcom/reown/foundation/network/model/RelayDTO_Subscribe_Result_JsonRpcErrorJsonAdapter;", "Lcom/squareup/moshi/JsonAdapter;", "Lcom/reown/foundation/network/model/RelayDTO$Subscribe$Result$JsonRpcError;", "moshi", "Lcom/squareup/moshi/Moshi;", "<init>", "(Lcom/squareup/moshi/Moshi;)V", "options", "Lcom/squareup/moshi/JsonReader$Options;", "stringAdapter", "", "errorAdapter", "Lcom/reown/foundation/network/model/RelayDTO$Error;", "longAdapter", "", "constructorRef", "Ljava/lang/reflect/Constructor;", "toString", "fromJson", "reader", "Lcom/squareup/moshi/JsonReader;", "toJson", "", "writer", "Lcom/squareup/moshi/JsonWriter;", "value_", "foundation"}, k = 1, mv = {2, 2, 0}, xi = 48)
@SourceDebugExtension({"SMAP\nRelayDTO_Subscribe_Result_JsonRpcErrorJsonAdapter.kt\nKotlin\n*S Kotlin\n*F\n+ 1 RelayDTO_Subscribe_Result_JsonRpcErrorJsonAdapter.kt\ncom/reown/foundation/network/model/RelayDTO_Subscribe_Result_JsonRpcErrorJsonAdapter\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,108:1\n1#2:109\n*E\n"})
public final class RelayDTO_Subscribe_Result_JsonRpcErrorJsonAdapter extends JsonAdapter<RelayDTO.Subscribe.Result.JsonRpcError> {
    ...
    public RelayDTO_Subscribe_Result_JsonRpcErrorJsonAdapter(@NotNull Moshi moshi) {
    ...
    public String toString() {
        return a.j(60, "GeneratedJsonAdapter(RelayDTO.Subscribe.Result.JsonRpcError)");
    }

    @NotNull
    public RelayDTO.Subscribe.Result.JsonRpcError fromJson(@NotNull JsonReader jsonReader) {
        ...
        if (i3 == -2) {
            ...
            if (error == null) {
                ...
                return new RelayDTO.Subscribe.Result.JsonRpcError(str, error, l2.longValue());
            } else {
            ...
            if (constructor == null) {
                constructor = RelayDTO.Subscribe.Result.JsonRpcError.class.getDeclaredConstructor(new Class[]{String.class, RelayDTO.Error.class, Long.TYPE, Integer.TYPE, Util.DEFAULT_CONSTRUCTOR_MARKER});
            ...
            if (error == null) {
                ...
                RelayDTO.Subscribe.Result.JsonRpcError newInstance = constructor.newInstance(new Object[]{str, error, l2, Integer.valueOf(i3), null});
    ...
    public void toJson(@NotNull JsonWriter jsonWriter, @Nullable RelayDTO.Subscribe.Result.JsonRpcError jsonRpcError) {
