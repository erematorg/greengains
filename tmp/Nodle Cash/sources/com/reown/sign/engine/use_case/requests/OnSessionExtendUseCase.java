...
public final class OnSessionExtendUseCase {
    ...
    public OnSessionExtendUseCase(@NotNull RelayJsonRpcInteractorInterface relayJsonRpcInteractorInterface, @NotNull SessionStorageRepository sessionStorageRepository2, @NotNull Logger logger2) {
    ...
    public final Object invoke(@NotNull WCRequest wCRequest, @NotNull SignParams.ExtendParams extendParams, @NotNull Continuation<? super Unit> continuation) {
        Object supervisorScope = SupervisorKt.supervisorScope(new OnSessionExtendUseCase$invoke$2(wCRequest, this, extendParams, (Continuation<? super OnSessionExtendUseCase$invoke$2>) null), continuation);
