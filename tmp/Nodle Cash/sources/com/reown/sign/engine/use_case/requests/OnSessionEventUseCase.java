...
public final class OnSessionEventUseCase {
    ...
    public OnSessionEventUseCase(@NotNull RelayJsonRpcInteractorInterface relayJsonRpcInteractorInterface, @NotNull SessionStorageRepository sessionStorageRepository2, @NotNull Logger logger2) {
    ...
    public final Object invoke(@NotNull WCRequest wCRequest, @NotNull SignParams.EventParams eventParams, @NotNull Continuation<? super Unit> continuation) {
        Object supervisorScope = SupervisorKt.supervisorScope(new OnSessionEventUseCase$invoke$2(this, wCRequest, eventParams, (Continuation<? super OnSessionEventUseCase$invoke$2>) null), continuation);
