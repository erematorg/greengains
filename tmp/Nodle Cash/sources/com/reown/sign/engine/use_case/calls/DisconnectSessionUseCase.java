...
public final class DisconnectSessionUseCase implements DisconnectSessionUseCaseInterface {
    ...
    public DisconnectSessionUseCase(@NotNull RelayJsonRpcInteractorInterface relayJsonRpcInteractorInterface, @NotNull SessionStorageRepository sessionStorageRepository2, @NotNull Logger logger2) {
    ...
    public Object disconnect(@NotNull String str, @NotNull Function0<Unit> function0, @NotNull Function1<? super Throwable, Unit> function1, @NotNull Continuation<? super Unit> continuation) {
        Object supervisorScope = SupervisorKt.supervisorScope(new DisconnectSessionUseCase$disconnect$2(this, str, function1, function0, (Continuation<? super DisconnectSessionUseCase$disconnect$2>) null), continuation);
