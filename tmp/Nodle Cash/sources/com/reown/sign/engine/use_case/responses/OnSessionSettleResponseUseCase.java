...
public final class OnSessionSettleResponseUseCase {
    ...
    public OnSessionSettleResponseUseCase(@NotNull SessionStorageRepository sessionStorageRepository2, @NotNull RelayJsonRpcInteractorInterface relayJsonRpcInteractorInterface, @NotNull MetadataStorageRepositoryInterface metadataStorageRepositoryInterface, @NotNull KeyManagementRepository keyManagementRepository, @NotNull Logger logger2) {
    ...
    public final Object invoke(@NotNull WCResponse wCResponse, @NotNull Continuation<? super Unit> continuation) {
        Object supervisorScope = SupervisorKt.supervisorScope(new OnSessionSettleResponseUseCase$invoke$2(this, wCResponse, (Continuation<? super OnSessionSettleResponseUseCase$invoke$2>) null), continuation);
