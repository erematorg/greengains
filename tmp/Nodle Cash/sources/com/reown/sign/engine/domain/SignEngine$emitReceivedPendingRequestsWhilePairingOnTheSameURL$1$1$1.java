...
@DebugMetadata(c = "com.reown.sign.engine.domain.SignEngine$emitReceivedPendingRequestsWhilePairingOnTheSameURL$1$1$1", f = "SignEngine.kt", i = {}, l = {478}, m = "invokeSuspend", n = {}, s = {})
public final class SignEngine$emitReceivedPendingRequestsWhilePairingOnTheSameURL$1$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ EngineDO.SessionAuthenticateEvent $sessionAuthenticateEvent;
    int label;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i3 == 0) {
            ...
            this.label = 1;
            if (access$get_engineEvent$p.emit(sessionAuthenticateEvent, this) == coroutine_suspended) {
