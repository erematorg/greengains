...
public final class Requester {
    ...
    public Requester(@NotNull @Json(name = "publicKey") String str, @NotNull @Json(name = "metadata") AppMetaData appMetaData) {
    ...
    public static /* synthetic */ Requester copy$default(Requester requester, String str, AppMetaData appMetaData, int i3, Object obj) {
        if ((i3 & 1) != 0) {
    ...
    @NotNull
    public final Requester copy(@NotNull @Json(name = "publicKey") String str, @NotNull @Json(name = "metadata") AppMetaData appMetaData) {
        Intrinsics.checkNotNullParameter(str, "publicKey");
        Intrinsics.checkNotNullParameter(appMetaData, TtmlNode.TAG_METADATA);
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.publicKey, (Object) requester.publicKey) && Intrinsics.areEqual((Object) this.metadata, (Object) requester.metadata);
    }
