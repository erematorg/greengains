...
public final class SessionParticipant {
    ...
    public SessionParticipant(@NotNull @Json(name = "publicKey") String str, @NotNull @Json(name = "metadata") AppMetaData appMetaData) {
    ...
    public static /* synthetic */ SessionParticipant copy$default(SessionParticipant sessionParticipant, String str, AppMetaData appMetaData, int i3, Object obj) {
        if ((i3 & 1) != 0) {
    ...
    @NotNull
    public final SessionParticipant copy(@NotNull @Json(name = "publicKey") String str, @NotNull @Json(name = "metadata") AppMetaData appMetaData) {
        Intrinsics.checkNotNullParameter(str, "publicKey");
        Intrinsics.checkNotNullParameter(appMetaData, TtmlNode.TAG_METADATA);
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.publicKey, (Object) sessionParticipant.publicKey) && Intrinsics.areEqual((Object) this.metadata, (Object) sessionParticipant.metadata);
    }
    ...
    public String toString() {
        ...
        return "SessionParticipant(publicKey=" + str + ", metadata=" + appMetaData + ")";
    }
}
