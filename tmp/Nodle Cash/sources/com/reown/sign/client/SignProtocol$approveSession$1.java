...
@DebugMetadata(c = "com.reown.sign.client.SignProtocol$approveSession$1", f = "SignProtocol.kt", i = {}, l = {219}, m = "invokeSuspend", n = {}, s = {})
public final class SignProtocol$approveSession$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ Sign.Params.Approve $approve;
    final /* synthetic */ Function1<Sign.Model.Error, Unit> $onError;
    final /* synthetic */ Function1<Sign.Params.Approve, Unit> $onSuccess;
    int label;
    final /* synthetic */ SignProtocol this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SignProtocol$approveSession$1(SignProtocol signProtocol, Sign.Params.Approve approve, Function1<? super Sign.Model.Error, Unit> function1, Function1<? super Sign.Params.Approve, Unit> function12, Continuation<? super SignProtocol$approveSession$1> continuation) {
    ...
    public static final Unit invokeSuspend$lambda$0(Function1 function1, Sign.Params.Approve approve) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i3 == 0) {
            ...
            Map<String, String> scopedProperties = this.$approve.getScopedProperties();
            c cVar = new c(this.$onSuccess, this.$approve, 1);
            d dVar = new d(this.$onError, 1);
            this.label = 1;
            if (signEngine.approve(proposerPublicKey, mapOfEngineNamespacesSession, properties, scopedProperties, cVar, dVar, this) == coroutine_suspended) {
