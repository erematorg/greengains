...
public final class GetPendingSessionAuthenticateRequest {
    ...
    public GetPendingSessionAuthenticateRequest(@NotNull JsonRpcHistory jsonRpcHistory2, @NotNull JsonRpcSerializer jsonRpcSerializer) {
    ...
    public final Request<SignParams.SessionAuthenticateParams> invoke$sign_release(long j2) {
        ...
        if (sessionAuthenticate != null) {
            return JsonRpcMapperKt.toRequest(pendingRecordById, sessionAuthenticate.getParams());
        }
        return null;
    }
}
