...
public final /* synthetic */ class ProposalStorageRepository$getProposalByTopic$1 extends FunctionReferenceImpl implements Function13<Long, String, String, String, String, List<? extends String>, String, String, String, Map<String, ? extends String>, String, Long, Map<String, ? extends String>, ProposalVO> {
