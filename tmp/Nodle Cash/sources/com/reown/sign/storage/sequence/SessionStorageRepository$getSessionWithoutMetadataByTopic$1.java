...
public final /* synthetic */ class SessionStorageRepository$getSessionWithoutMetadataByTopic$1 extends FunctionReferenceImpl implements Function13<Long, String, Long, String, String, String, String, String, Boolean, String, Map<String, ? extends String>, TransportType, Map<String, ? extends String>, SessionVO> {
