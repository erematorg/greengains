...
public final class GetSessionByTopic {
    ...
    public GetSessionByTopic(long j2, @NotNull String str, long j3, @NotNull String str2, @Nullable String str3, @Nullable String str4, @NotNull String str5, @Nullable String str6, boolean z2, @NotNull String str7, @Nullable Map<String, String> map, @Nullable TransportType transportType, @Nullable Map<String, String> map2) {
        String str8 = str5;
        String str9 = str7;
    ...
    public static /* synthetic */ GetSessionByTopic copy$default(GetSessionByTopic getSessionByTopic, long j2, String str, long j3, String str2, String str3, String str4, String str5, String str6, boolean z2, String str7, Map map, TransportType transportType, Map map2, int i3, Object obj) {
        GetSessionByTopic getSessionByTopic2 = getSessionByTopic;
        int i4 = i3;
        return getSessionByTopic.copy((i4 & 1) != 0 ? getSessionByTopic2.id : j2, (i4 & 2) != 0 ? getSessionByTopic2.topic : str, (i4 & 4) != 0 ? getSessionByTopic2.expiry : j3, (i4 & 8) != 0 ? getSessionByTopic2.relay_protocol : str2, (i4 & 16) != 0 ? getSessionByTopic2.relay_data : str3, (i4 & 32) != 0 ? getSessionByTopic2.controller_key : str4, (i4 & 64) != 0 ? getSessionByTopic2.self_participant : str5, (i4 & 128) != 0 ? getSessionByTopic2.peer_participant : str6, (i4 & 256) != 0 ? getSessionByTopic2.is_acknowledged : z2, (i4 & 512) != 0 ? getSessionByTopic2.pairingTopic : str7, (i4 & 1024) != 0 ? getSessionByTopic2.properties : map, (i4 & 2048) != 0 ? getSessionByTopic2.transport_type : transportType, (i4 & 4096) != 0 ? getSessionByTopic2.scoped_properties : map2);
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return this.id == getSessionByTopic.id && Intrinsics.areEqual((Object) this.topic, (Object) getSessionByTopic.topic) && this.expiry == getSessionByTopic.expiry && Intrinsics.areEqual((Object) this.relay_protocol, (Object) getSessionByTopic.relay_protocol) && Intrinsics.areEqual((Object) this.relay_data, (Object) getSessionByTopic.relay_data) && Intrinsics.areEqual((Object) this.controller_key, (Object) getSessionByTopic.controller_key) && Intrinsics.areEqual((Object) this.self_participant, (Object) getSessionByTopic.self_participant) && Intrinsics.areEqual((Object) this.peer_participant, (Object) getSessionByTopic.peer_participant) && this.is_acknowledged == getSessionByTopic.is_acknowledged && Intrinsics.areEqual((Object) this.pairingTopic, (Object) getSessionByTopic.pairingTopic) && Intrinsics.areEqual((Object) this.properties, (Object) getSessionByTopic.properties) && this.transport_type == getSessionByTopic.transport_type && Intrinsics.areEqual((Object) this.scoped_properties, (Object) getSessionByTopic.scoped_properties);
    }
    ...
    public String toString() {
        ...
        TransportType transportType = this.transport_type;
        Map<String, String> map2 = this.scoped_properties;
        StringBuilder v2 = androidx.work.impl.a.v(j2, "GetSessionByTopic(id=", ", topic=", str);
        v2.append(", expiry=");
        v2.append(j3);
