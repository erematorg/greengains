...
public final class OptionalNamespaceDao {
    ...
    public OptionalNamespaceDao(long j2, long j3, @NotNull String str, @Nullable List<String> list, @NotNull List<String> list2, @NotNull List<String> list3) {
    ...
    public static /* synthetic */ OptionalNamespaceDao copy$default(OptionalNamespaceDao optionalNamespaceDao, long j2, long j3, String str, List list, List list2, List list3, int i3, Object obj) {
        OptionalNamespaceDao optionalNamespaceDao2 = optionalNamespaceDao;
        return optionalNamespaceDao.copy((i3 & 1) != 0 ? optionalNamespaceDao2.id : j2, (i3 & 2) != 0 ? optionalNamespaceDao2.session_id : j3, (i3 & 4) != 0 ? optionalNamespaceDao2.key : str, (i3 & 8) != 0 ? optionalNamespaceDao2.chains : list, (i3 & 16) != 0 ? optionalNamespaceDao2.methods : list2, (i3 & 32) != 0 ? optionalNamespaceDao2.events : list3);
    }
    ...
    @NotNull
    public final OptionalNamespaceDao copy(long j2, long j3, @NotNull String str, @Nullable List<String> list, @NotNull List<String> list2, @NotNull List<String> list3) {
        Intrinsics.checkNotNullParameter(str, JwtUtilsKt.DID_METHOD_KEY);
        List<String> list4 = list2;
        Intrinsics.checkNotNullParameter(list4, "methods");
        List<String> list5 = list3;
        Intrinsics.checkNotNullParameter(list5, "events");
        return new OptionalNamespaceDao(j2, j3, str, list, list4, list5);
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return this.id == optionalNamespaceDao.id && this.session_id == optionalNamespaceDao.session_id && Intrinsics.areEqual((Object) this.key, (Object) optionalNamespaceDao.key) && Intrinsics.areEqual((Object) this.chains, (Object) optionalNamespaceDao.chains) && Intrinsics.areEqual((Object) this.methods, (Object) optionalNamespaceDao.methods) && Intrinsics.areEqual((Object) this.events, (Object) optionalNamespaceDao.events);
    }
    ...
    public String toString() {
        ...
        StringBuilder u3 = a.u("OptionalNamespaceDao(id=", j2, ", session_id=");
        u3.append(j3);
        u3.append(", key=");
        u3.append(str);
        u3.append(", chains=");
