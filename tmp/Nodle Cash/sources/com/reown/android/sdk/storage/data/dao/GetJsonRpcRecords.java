...
public final class GetJsonRpcRecords {
    ...
    public GetJsonRpcRecords(long j2, @NotNull String str, @NotNull String str2, @NotNull String str3, @Nullable String str4, @Nullable TransportType transportType) {
    ...
    public static /* synthetic */ GetJsonRpcRecords copy$default(GetJsonRpcRecords getJsonRpcRecords, long j2, String str, String str2, String str3, String str4, TransportType transportType, int i3, Object obj) {
        GetJsonRpcRecords getJsonRpcRecords2 = getJsonRpcRecords;
        return getJsonRpcRecords.copy((i3 & 1) != 0 ? getJsonRpcRecords2.request_id : j2, (i3 & 2) != 0 ? getJsonRpcRecords2.topic : str, (i3 & 4) != 0 ? getJsonRpcRecords2.method : str2, (i3 & 8) != 0 ? getJsonRpcRecords2.body : str3, (i3 & 16) != 0 ? getJsonRpcRecords2.response : str4, (i3 & 32) != 0 ? getJsonRpcRecords2.transport_type : transportType);
    }
    ...
    @NotNull
    public final GetJsonRpcRecords copy(long j2, @NotNull String str, @NotNull String str2, @NotNull String str3, @Nullable String str4, @Nullable TransportType transportType) {
        Intrinsics.checkNotNullParameter(str, PushMessagingService.KEY_TOPIC);
        Intrinsics.checkNotNullParameter(str2, FirebaseAnalytics.Param.METHOD);
        Intrinsics.checkNotNullParameter(str3, "body");
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return this.request_id == getJsonRpcRecords.request_id && Intrinsics.areEqual((Object) this.topic, (Object) getJsonRpcRecords.topic) && Intrinsics.areEqual((Object) this.method, (Object) getJsonRpcRecords.method) && Intrinsics.areEqual((Object) this.body, (Object) getJsonRpcRecords.body) && Intrinsics.areEqual((Object) this.response, (Object) getJsonRpcRecords.response) && this.transport_type == getJsonRpcRecords.transport_type;
    }
    ...
    public String toString() {
        ...
        TransportType transportType = this.transport_type;
        StringBuilder v2 = androidx.work.impl.a.v(j2, "GetJsonRpcRecords(request_id=", ", topic=", str);
