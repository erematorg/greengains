...
public final class InsertEventUseCase implements InsertEventUseCaseInterface {
    ...
    public InsertEventUseCase(@NotNull EventsRepository eventsRepository2, @NotNull Logger logger2) {
    ...
    public Object invoke(@NotNull Props props, @NotNull Continuation<? super Unit> continuation) {
        Object withContext = BuildersKt.withContext(Dispatchers.getIO(), new InsertEventUseCase$invoke$2(this, props, (Continuation<? super InsertEventUseCase$invoke$2>) null), continuation);
