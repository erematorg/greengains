...
public final class DesktopDTOJsonAdapter extends JsonAdapter<DesktopDTO> {
    ...
    public DesktopDTOJsonAdapter(@NotNull Moshi moshi) {
        ...
        this.stringAdapter = a.h(moshi, cls, "native", "adapter(...)");
        this.nullableStringAdapter = a.h(moshi, cls, "universal", "adapter(...)");
    }

    @NotNull
    public String toString() {
        return a.j(32, "GeneratedJsonAdapter(DesktopDTO)");
    }

    @NotNull
    public DesktopDTO fromJson(@NotNull JsonReader jsonReader) {
        ...
        while (jsonReader.hasNext()) {
            ...
            if (selectName == -1) {
                ...
                if (str == null) {
                    throw Util.unexpectedNull("native", "native", jsonReader);
                }
        ...
        throw Util.missingProperty("native", "native", jsonReader);
    }

    public void toJson(@NotNull JsonWriter jsonWriter, @Nullable DesktopDTO desktopDTO) {
