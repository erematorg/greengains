...
public final class AccountHasNoCacaoPayloadStored extends WalletConnectException {
    ...
    private AccountHasNoCacaoPayloadStored(String str) {
        super(a.l("AccountId: ", AccountId.m8755toStringimpl(str), " has no message stored"));
