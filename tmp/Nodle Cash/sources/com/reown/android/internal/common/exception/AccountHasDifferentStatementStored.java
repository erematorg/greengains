...
public final class AccountHasDifferentStatementStored extends WalletConnectException {
    ...
    private AccountHasDifferentStatementStored(String str) {
        super(a.l("AccountId: ", AccountId.m8755toStringimpl(str), " has old statement stored"));
