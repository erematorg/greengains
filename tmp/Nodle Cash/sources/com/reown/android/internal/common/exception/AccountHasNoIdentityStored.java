...
public final class AccountHasNoIdentityStored extends WalletConnectException {
    ...
    private AccountHasNoIdentityStored(String str) {
        super(a.l("AccountId: ", AccountId.m8755toStringimpl(str), " has no identity stored"));
