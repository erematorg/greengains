...
public final class Participant {
    ...
    public Participant(@NotNull @Json(name = "publicKey") String str, @NotNull @Json(name = "metadata") AppMetaData appMetaData) {
    ...
    @NotNull
    public final Participant copy(@NotNull @Json(name = "publicKey") String str, @NotNull @Json(name = "metadata") AppMetaData appMetaData) {
        Intrinsics.checkNotNullParameter(str, "publicKey");
        Intrinsics.checkNotNullParameter(appMetaData, TtmlNode.TAG_METADATA);
