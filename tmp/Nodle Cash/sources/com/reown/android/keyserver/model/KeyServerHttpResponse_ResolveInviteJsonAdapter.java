...
@Metadata(d1 = {"\u0000D\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0004¢\u0006\u0004\b\u0005\u0010\u0006J\b\u0010\u000f\u001a\u00020\nH\u0016J\u0010\u0010\u0010\u001a\u00020\u00022\u0006\u0010\u0011\u001a\u00020\u0012H\u0016J\u001a\u0010\u0013\u001a\u00020\u00142\u0006\u0010\u0015\u001a\u00020\u00162\b\u0010\u0017\u001a\u0004\u0018\u00010\u0002H\u0016R\u000e\u0010\u0007\u001a\u00020\bX\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\t\u001a\b\u0012\u0004\u0012\u00020\n0\u0001X\u0004¢\u0006\u0002\n\u0000R\u0016\u0010\u000b\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\f0\u0001X\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\r\u001a\b\u0012\u0004\u0012\u00020\u000e0\u0001X\u0004¢\u0006\u0002\n\u0000¨\u0006\u0018"}, d2 = {"Lcom/reown/android/keyserver/model/KeyServerHttpResponse_ResolveInviteJsonAdapter;", "Lcom/squareup/moshi/JsonAdapter;", "Lcom/reown/android/keyserver/model/KeyServerHttpResponse$ResolveInvite;", "moshi", "Lcom/squareup/moshi/Moshi;", "<init>", "(Lcom/squareup/moshi/Moshi;)V", "options", "Lcom/squareup/moshi/JsonReader$Options;", "stringAdapter", "", "nullableErrorAdapter", "Lcom/reown/android/keyserver/model/KeyServerHttpResponse$Error;", "resolveInviteAdapter", "Lcom/reown/android/keyserver/model/KeyServerResponse$ResolveInvite;", "toString", "fromJson", "reader", "Lcom/squareup/moshi/JsonReader;", "toJson", "", "writer", "Lcom/squareup/moshi/JsonWriter;", "value_", "android_release"}, k = 1, mv = {2, 2, 0}, xi = 48)
public final class KeyServerHttpResponse_ResolveInviteJsonAdapter extends JsonAdapter<KeyServerHttpResponse.ResolveInvite> {
    ...
    @NotNull
    private final JsonAdapter<KeyServerResponse.ResolveInvite> resolveInviteAdapter;
    @NotNull
    ...
    public KeyServerHttpResponse_ResolveInviteJsonAdapter(@NotNull Moshi moshi) {
        ...
        this.resolveInviteAdapter = a.h(moshi, KeyServerResponse.ResolveInvite.class, "value", "adapter(...)");
    }

    @NotNull
    public String toString() {
        return a.j(57, "GeneratedJsonAdapter(KeyServerHttpResponse.ResolveInvite)");
    }

    @NotNull
    public KeyServerHttpResponse.ResolveInvite fromJson(@NotNull JsonReader jsonReader) {
        Intrinsics.checkNotNullParameter(jsonReader, "reader");
        jsonReader.beginObject();
        String str = null;
        KeyServerHttpResponse.Error error = null;
        KeyServerResponse.ResolveInvite resolveInvite = null;
        while (jsonReader.hasNext()) {
            ...
            } else if (selectName == 2 && (resolveInvite = this.resolveInviteAdapter.fromJson(jsonReader)) == null) {
        ...
        } else if (resolveInvite != null) {
            return new KeyServerHttpResponse.ResolveInvite(str, error, resolveInvite);
        } else {
            throw Util.missingProperty("value__", "value", jsonReader);
        }
    }

    public void toJson(@NotNull JsonWriter jsonWriter, @Nullable KeyServerHttpResponse.ResolveInvite resolveInvite) {
