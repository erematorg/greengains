...
@Metadata(d1 = {"\u0000>\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0004¢\u0006\u0004\b\u0005\u0010\u0006J\b\u0010\u000e\u001a\u00020\nH\u0016J\u0010\u0010\u000f\u001a\u00020\u00022\u0006\u0010\u0010\u001a\u00020\u0011H\u0016J\u001a\u0010\u0012\u001a\u00020\u00132\u0006\u0010\u0014\u001a\u00020\u00152\b\u0010\u0016\u001a\u0004\u0018\u00010\u0002H\u0016R\u000e\u0010\u0007\u001a\u00020\bX\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\t\u001a\b\u0012\u0004\u0012\u00020\n0\u0001X\u0004¢\u0006\u0002\n\u0000R\u0016\u0010\u000b\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\f0\u0001X\u0004¢\u0006\u0002\n\u0000R\u0016\u0010\r\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\n0\u0001X\u0004¢\u0006\u0002\n\u0000¨\u0006\u0017"}, d2 = {"Lcom/reown/android/keyserver/model/KeyServerHttpResponse_UnregisterIdentityJsonAdapter;", "Lcom/squareup/moshi/JsonAdapter;", "Lcom/reown/android/keyserver/model/KeyServerHttpResponse$UnregisterIdentity;", "moshi", "Lcom/squareup/moshi/Moshi;", "<init>", "(Lcom/squareup/moshi/Moshi;)V", "options", "Lcom/squareup/moshi/JsonReader$Options;", "stringAdapter", "", "nullableErrorAdapter", "Lcom/reown/android/keyserver/model/KeyServerHttpResponse$Error;", "nullableStringAdapter", "toString", "fromJson", "reader", "Lcom/squareup/moshi/JsonReader;", "toJson", "", "writer", "Lcom/squareup/moshi/JsonWriter;", "value_", "android_release"}, k = 1, mv = {2, 2, 0}, xi = 48)
public final class KeyServerHttpResponse_UnregisterIdentityJsonAdapter extends JsonAdapter<KeyServerHttpResponse.UnregisterIdentity> {
    @NotNull
    ...
    public KeyServerHttpResponse_UnregisterIdentityJsonAdapter(@NotNull Moshi moshi) {
    ...
    public String toString() {
        return a.j(62, "GeneratedJsonAdapter(KeyServerHttpResponse.UnregisterIdentity)");
    }

    @NotNull
    public KeyServerHttpResponse.UnregisterIdentity fromJson(@NotNull JsonReader jsonReader) {
        ...
        if (str != null) {
            return new KeyServerHttpResponse.UnregisterIdentity(str, error, str2);
        }
        throw Util.missingProperty(NotificationCompat.CATEGORY_STATUS, NotificationCompat.CATEGORY_STATUS, jsonReader);
    }

    public void toJson(@NotNull JsonWriter jsonWriter, @Nullable KeyServerHttpResponse.UnregisterIdentity unregisterIdentity) {
        Intrinsics.checkNotNullParameter(jsonWriter, "writer");
        if (unregisterIdentity != null) {
            jsonWriter.beginObject();
            jsonWriter.name(NotificationCompat.CATEGORY_STATUS);
            this.stringAdapter.toJson(jsonWriter, unregisterIdentity.getStatus());
            jsonWriter.name(Constants.IPC_BUNDLE_KEY_SEND_ERROR);
            this.nullableErrorAdapter.toJson(jsonWriter, unregisterIdentity.getError());
            jsonWriter.name("value");
            this.nullableStringAdapter.toJson(jsonWriter, unregisterIdentity.getValue());
