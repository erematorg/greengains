...
@Metadata(d1 = {"\u0000D\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0004¢\u0006\u0004\b\u0005\u0010\u0006J\b\u0010\r\u001a\u00020\u000eH\u0016J\u0010\u0010\u000f\u001a\u00020\u00022\u0006\u0010\u0010\u001a\u00020\u0011H\u0016J\u001a\u0010\u0012\u001a\u00020\u00132\u0006\u0010\u0014\u001a\u00020\u00152\b\u0010\u0016\u001a\u0004\u0018\u00010\u0002H\u0016R\u000e\u0010\u0007\u001a\u00020\bX\u0004¢\u0006\u0002\n\u0000R\u0016\u0010\t\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\n0\u0001X\u0004¢\u0006\u0002\n\u0000R\u0016\u0010\u000b\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\f0\u0001X\u0004¢\u0006\u0002\n\u0000¨\u0006\u0017"}, d2 = {"Lcom/reown/android/verify/model/VerifyServerResponse_ResolveAttestationJsonAdapter;", "Lcom/squareup/moshi/JsonAdapter;", "Lcom/reown/android/verify/model/VerifyServerResponse$ResolveAttestation;", "moshi", "Lcom/squareup/moshi/Moshi;", "<init>", "(Lcom/squareup/moshi/Moshi;)V", "options", "Lcom/squareup/moshi/JsonReader$Options;", "nullableErrorAdapter", "Lcom/reown/android/verify/model/VerifyServerResponse$Error;", "nullableOriginAdapter", "Lcom/reown/android/verify/model/Origin;", "toString", "", "fromJson", "reader", "Lcom/squareup/moshi/JsonReader;", "toJson", "", "writer", "Lcom/squareup/moshi/JsonWriter;", "value_", "android_release"}, k = 1, mv = {2, 2, 0}, xi = 48)
public final class VerifyServerResponse_ResolveAttestationJsonAdapter extends JsonAdapter<VerifyServerResponse.ResolveAttestation> {
    ...
    @NotNull
    private final JsonAdapter<Origin> nullableOriginAdapter;
    @NotNull
    ...
    public VerifyServerResponse_ResolveAttestationJsonAdapter(@NotNull Moshi moshi) {
        ...
        this.nullableOriginAdapter = a.h(moshi, Origin.class, "value", "adapter(...)");
    }

    @NotNull
    public String toString() {
        return a.j(61, "GeneratedJsonAdapter(VerifyServerResponse.ResolveAttestation)");
    }

    @NotNull
    public VerifyServerResponse.ResolveAttestation fromJson(@NotNull JsonReader jsonReader) {
        ...
        while (jsonReader.hasNext()) {
            ...
            if (selectName == -1) {
                ...
                origin = this.nullableOriginAdapter.fromJson(jsonReader);
            }
        }
        jsonReader.endObject();
        return new VerifyServerResponse.ResolveAttestation(error, origin);
    }

    public void toJson(@NotNull JsonWriter jsonWriter, @Nullable VerifyServerResponse.ResolveAttestation resolveAttestation) {
