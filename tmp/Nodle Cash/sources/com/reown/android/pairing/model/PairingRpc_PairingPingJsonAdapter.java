...
public final class PairingRpc_PairingPingJsonAdapter extends JsonAdapter<PairingRpc.PairingPing> {
    ...
    public PairingRpc_PairingPingJsonAdapter(@NotNull Moshi moshi) {
        ...
        this.pingParamsAdapter = a.h(moshi, PairingParams.PingParams.class, "params", "adapter(...)");
    }

    @NotNull
    public String toString() {
        return a.j(44, "GeneratedJsonAdapter(PairingRpc.PairingPing)");
    }

    @NotNull
    public PairingRpc.PairingPing fromJson(@NotNull JsonReader jsonReader) {
        ...
        String str = null;
        String str2 = null;
        PairingParams.PingParams pingParams = null;
        int i3 = -1;
        ...
        if (i3 == -8) {
            ...
            if (pingParams != null) {
                return new PairingRpc.PairingPing(longValue, str, str2, pingParams);
            }
            throw Util.missingProperty("params", "params", jsonReader2);
        }
        Constructor<PairingRpc.PairingPing> constructor = this.constructorRef;
        if (constructor == null) {
            constructor = PairingRpc.PairingPing.class.getDeclaredConstructor(new Class[]{Long.TYPE, String.class, String.class, PairingParams.PingParams.class, Integer.TYPE, Util.DEFAULT_CONSTRUCTOR_MARKER});
            this.constructorRef = constructor;
            Intrinsics.checkNotNullExpressionValue(constructor, "also(...)");
        }
        if (pingParams != null) {
            PairingRpc.PairingPing newInstance = constructor.newInstance(new Object[]{l2, str, str2, pingParams, Integer.valueOf(i3), null});
    ...
    public void toJson(@NotNull JsonWriter jsonWriter, @Nullable PairingRpc.PairingPing pairingPing) {
