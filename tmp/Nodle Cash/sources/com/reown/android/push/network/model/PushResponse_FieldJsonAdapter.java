...
@Metadata(d1 = {"\u00008\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0004¢\u0006\u0004\b\u0005\u0010\u0006J\b\u0010\u000b\u001a\u00020\nH\u0016J\u0010\u0010\f\u001a\u00020\u00022\u0006\u0010\r\u001a\u00020\u000eH\u0016J\u001a\u0010\u000f\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u00122\b\u0010\u0013\u001a\u0004\u0018\u00010\u0002H\u0016R\u000e\u0010\u0007\u001a\u00020\bX\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\t\u001a\b\u0012\u0004\u0012\u00020\n0\u0001X\u0004¢\u0006\u0002\n\u0000¨\u0006\u0014"}, d2 = {"Lcom/reown/android/push/network/model/PushResponse_FieldJsonAdapter;", "Lcom/squareup/moshi/JsonAdapter;", "Lcom/reown/android/push/network/model/PushResponse$Field;", "moshi", "Lcom/squareup/moshi/Moshi;", "<init>", "(Lcom/squareup/moshi/Moshi;)V", "options", "Lcom/squareup/moshi/JsonReader$Options;", "stringAdapter", "", "toString", "fromJson", "reader", "Lcom/squareup/moshi/JsonReader;", "toJson", "", "writer", "Lcom/squareup/moshi/JsonWriter;", "value_", "android_release"}, k = 1, mv = {2, 2, 0}, xi = 48)
public final class PushResponse_FieldJsonAdapter extends JsonAdapter<PushResponse.Field> {
    ...
    public PushResponse_FieldJsonAdapter(@NotNull Moshi moshi) {
        ...
        JsonReader.Options of = JsonReader.Options.of("description", "field", FirebaseAnalytics.Param.LOCATION);
        Intrinsics.checkNotNullExpressionValue(of, "of(...)");
        this.options = of;
        this.stringAdapter = a.h(moshi, String.class, "description", "adapter(...)");
    }

    @NotNull
    public String toString() {
        return a.j(40, "GeneratedJsonAdapter(PushResponse.Field)");
    }

    @NotNull
    public PushResponse.Field fromJson(@NotNull JsonReader jsonReader) {
        ...
        while (jsonReader.hasNext()) {
            ...
            if (selectName == -1) {
                ...
                throw Util.unexpectedNull(FirebaseAnalytics.Param.LOCATION, FirebaseAnalytics.Param.LOCATION, jsonReader);
            }
        }
        ...
        if (str == null) {
            ...
            throw Util.missingProperty(FirebaseAnalytics.Param.LOCATION, FirebaseAnalytics.Param.LOCATION, jsonReader);
        }
    }

    public void toJson(@NotNull JsonWriter jsonWriter, @Nullable PushResponse.Field field) {
