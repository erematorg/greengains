...
@DebugMetadata(c = "com.reown.android.push.client.PushClient$register$1", f = "PushClient.kt", i = {}, l = {30}, m = "invokeSuspend", n = {}, s = {})
public final class PushClient$register$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ PushBody $body;
    final /* synthetic */ Function1<Throwable, Unit> $onError;
    final /* synthetic */ Function0<Unit> $onSuccess;
    int label;

    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {2, 2, 0}, xi = 48)
    @DebugMetadata(c = "com.reown.android.push.client.PushClient$register$1$1", f = "PushClient.kt", i = {}, l = {32}, m = "invokeSuspend", n = {}, s = {})
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new AnonymousClass1(pushBody, function0, function1, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i3 == 0) {
                ...
                this.label = 1;
                obj = access$getPushService.register(value, clientId, pushBody, this);
    ...
    public PushClient$register$1(PushBody pushBody, Function0<Unit> function0, Function1<? super Throwable, Unit> function1, Continuation<? super PushClient$register$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new PushClient$register$1(this.$body, this.$onSuccess, this.$onError, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i3 == 0) {
            ResultKt.throwOnFailure(obj);
            final PushBody pushBody = this.$body;
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((PushClient$register$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
