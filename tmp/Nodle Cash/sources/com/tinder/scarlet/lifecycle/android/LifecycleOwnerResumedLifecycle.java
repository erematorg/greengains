...
public final class LifecycleOwnerResumedLifecycle implements Lifecycle {
    ...
    public final class ALifecycleObserver implements LifecycleObserver {
        ...
        public final void onPause() {
            LifecycleOwnerResumedLifecycle.this.lifecycleRegistry.onNext((Lifecycle.State) new Lifecycle.State.Stopped.WithReason(new ShutdownReason(1000, "Paused")));
        }
    ...
    public LifecycleOwnerResumedLifecycle(@NotNull LifecycleOwner lifecycleOwner2, @NotNull LifecycleRegistry lifecycleRegistry2) {
