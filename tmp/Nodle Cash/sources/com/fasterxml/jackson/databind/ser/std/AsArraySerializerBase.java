...
public abstract class AsArraySerializerBase<T> extends ContainerSerializer<T> implements ContextualSerializer {
    ...
    public AsArraySerializerBase(Class<?> cls, JavaType javaType, boolean z2, TypeSerializer typeSerializer, JsonSerializer<Object> jsonSerializer) {
        this(cls, javaType, z2, typeSerializer, (BeanProperty) null, jsonSerializer, (Boolean) null);
    }
    ...
    public void serialize(T t2, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
        if (!serializerProvider.isEnabled(SerializationFeature.WRITE_SINGLE_ELEM_ARRAYS_UNWRAPPED) || !hasSingleElement(t2)) {
    ...
    @Deprecated
    public AsArraySerializerBase(Class<?> cls, JavaType javaType, boolean z2, TypeSerializer typeSerializer, BeanProperty beanProperty, JsonSerializer<Object> jsonSerializer) {
        this(cls, javaType, z2, typeSerializer, beanProperty, jsonSerializer, (Boolean) null);
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AsArraySerializerBase(Class<?> cls, JavaType javaType, boolean z2, TypeSerializer typeSerializer, BeanProperty beanProperty, JsonSerializer<?> jsonSerializer, Boolean bool) {
        super(cls, false);
        boolean z3 = false;
        this._elementType = javaType;
        if (z2 || (javaType != null && javaType.isFinal())) {
            z3 = true;
        }
