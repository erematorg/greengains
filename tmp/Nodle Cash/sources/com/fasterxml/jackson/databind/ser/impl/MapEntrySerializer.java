...
public class MapEntrySerializer extends ContainerSerializer<Map.Entry<?, ?>> implements ContextualSerializer {
    ...
    public void serializeDynamic(Map.Entry<?, ?> entry, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
        ...
        if (typeSerializer == null) {
            try {
                ...
                wrapAndThrow(serializerProvider, (Throwable) e3, (Object) entry, f.a(key, ""));
            }
        } else {
    ...
    public MapEntrySerializer withContentInclusion(Object obj, boolean z2) {
        if (this._suppressableValue == obj && this._suppressNulls == z2) {
            return this;
        }
        return new MapEntrySerializer(this, this._property, this._valueTypeSerializer, this._keySerializer, this._valueSerializer, obj, z2);
    }
