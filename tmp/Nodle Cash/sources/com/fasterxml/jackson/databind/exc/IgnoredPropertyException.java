...
public class IgnoredPropertyException extends PropertyBindingException {
    ...
    public static IgnoredPropertyException from(JsonParser jsonParser, Object obj, String str, Collection<Object> collection) {
        ...
        IgnoredPropertyException ignoredPropertyException = new IgnoredPropertyException(jsonParser, C0118y.g("Ignored field \"", str, "\" (class ", cls.getName(), ") encountered; mapper configured not to allow this"), jsonParser.getCurrentLocation(), cls, str, collection);
