                    ...
                    if (findCreatorProperty == null) {
                        ...
                        try {
                            ...
                            if (obj.getClass() != this._beanType.getRawClass()) {
                                ...
                                return deserializationContext.reportBadDefinition(javaType, C0118y.f("Cannot support implicit polymorphic deserialization for POJOs-as-Arrays style: nominal type ", ClassUtil.getTypeDescription(javaType), ", actual type ", obj.getClass().getName()));
                            }
                        } catch (Exception e4) {
