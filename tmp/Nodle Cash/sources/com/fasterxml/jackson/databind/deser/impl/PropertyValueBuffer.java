...
public class PropertyValueBuffer {
    ...
    public Object _findMissing(SettableBeanProperty settableBeanProperty) throws JsonMappingException {
        ...
        try {
            ...
            if (member != null) {
                e3.prependPath((Object) member.getDeclaringClass(), settableBeanProperty.getName());
            }
            throw e3;
        }
    }
        ...
        if (this._context.isEnabled(DeserializationFeature.FAIL_ON_NULL_CREATOR_PROPERTIES)) {
            for (int i6 = 0; i6 < settableBeanPropertyArr.length; i6++) {
                if (this._creatorParameters[i6] == null) {
                    ...
                    this._context.reportInputMismatch((BeanProperty) settableBeanProperty, "Null value for creator property '%s' (index %d); `DeserializationFeature.FAIL_ON_NULL_CREATOR_PROPERTIES` enabled", settableBeanProperty.getName(), Integer.valueOf(settableBeanPropertyArr[i6].getCreatorIndex()));
                }
            }
        }
