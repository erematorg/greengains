...
public class EnumMapDeserializer extends ContainerDeserializerBase<EnumMap<?, ?>> implements ContextualDeserializer, ResolvableDeserializer {
        ...
        while (nextFieldName != null) {
            ...
            if (findCreatorProperty == null) {
                ...
                try {
                    ...
                    return (EnumMap) wrapAndThrow(deserializationContext, e4, this._containerType.getRawClass(), nextFieldName);
                }
            }
    ...
    public EnumMap<?, ?> constructMap(DeserializationContext deserializationContext) throws JsonMappingException {
        ...
        try {
            ...
            return (EnumMap) ClassUtil.throwAsMappingException(deserializationContext, e3);
        }
    }
        ...
        while (str != null) {
            ...
            if (enumR != null) {
                try {
                    ...
                    return (EnumMap) wrapAndThrow(deserializationContext, e3, enumMap, str);
                }
            } else if (!deserializationContext.isEnabled(DeserializationFeature.READ_UNKNOWN_ENUM_VALUES_AS_NULL)) {
