...
public abstract class MapperBuilder<M extends ObjectMapper, B extends MapperBuilder<M, B>> {
    ...
    public B configure(MapperFeature mapperFeature, boolean z2) {
        this._mapper.configure(mapperFeature, z2);
        return _this();
    }
    ...
    public B removeMixIn(Class<?> cls) {
        this._mapper.addMixIn(cls, (Class<?>) null);
        return _this();
    }
    ...
    public B configure(SerializationFeature serializationFeature, boolean z2) {
        this._mapper.configure(serializationFeature, z2);
        return _this();
    }
    ...
    public B configure(DeserializationFeature deserializationFeature, boolean z2) {
        this._mapper.configure(deserializationFeature, z2);
        return _this();
    }
    ...
    public B configure(DatatypeFeature datatypeFeature, boolean z2) {
        this._mapper.configure(datatypeFeature, z2);
        return _this();
    }

    public B configure(JsonParser.Feature feature, boolean z2) {
        this._mapper.configure(feature, z2);
        return _this();
    }

    public B disable(DatatypeFeature... datatypeFeatureArr) {
        for (DatatypeFeature configure : datatypeFeatureArr) {
            this._mapper.configure(configure, false);
        }
        return _this();
    }
    ...
    public B enable(DatatypeFeature... datatypeFeatureArr) {
        for (DatatypeFeature configure : datatypeFeatureArr) {
            this._mapper.configure(configure, true);
        }
        return _this();
    }

    public B configure(JsonGenerator.Feature feature, boolean z2) {
        this._mapper.configure(feature, z2);
        return _this();
    }
    ...
    public B configure(StreamReadFeature streamReadFeature, boolean z2) {
        this._mapper.configure(streamReadFeature.mappedFeature(), z2);
        return _this();
    }
    ...
    public B configure(StreamWriteFeature streamWriteFeature, boolean z2) {
        this._mapper.configure(streamWriteFeature.mappedFeature(), z2);
        return _this();
    }
