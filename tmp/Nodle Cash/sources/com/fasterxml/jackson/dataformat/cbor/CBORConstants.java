...
public final class CBORConstants {
    ...
    public static final byte BYTE_STRING_INDEFINITE = Byte.MAX_VALUE;
    ...
    static {
        ...
        for (int i3 = 128; i3 < 256; i3++) {
            iArr[i3] = (i3 & 224) == 192 ? 1 : (i3 & 240) == 224 ? 2 : (i3 & 248) == 240 ? 3 : -1;
        }
        sUtf8UnitLengths = iArr;
    }

    public static boolean hasMajorType(int i3, byte b3) {
        return ((b3 & MessagePack.Code.NEGFIXINT_PREFIX) >> 5) == i3;
    }
}
