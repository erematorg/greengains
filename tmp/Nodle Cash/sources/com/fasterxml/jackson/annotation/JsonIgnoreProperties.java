...
public @interface JsonIgnoreProperties {
    ...
    public static class Value implements JacksonAnnotationValue<JsonIgnoreProperties>, Serializable {
        ...
        public static Value construct(Set<String> set, boolean z2, boolean z3, boolean z4, boolean z5) {
            return _empty(set, z2, z3, z4, z5) ? EMPTY : new Value(set, z2, z3, z4, z5);
        }
        ...
        public static Value forIgnoreUnknown(boolean z2) {
            return z2 ? EMPTY.withIgnoreUnknown() : EMPTY.withoutIgnoreUnknown();
        }
        ...
        public Value withOverrides(Value value) {
            ...
            boolean z2 = false;
            boolean z3 = this._ignoreUnknown || value._ignoreUnknown;
            boolean z4 = this._allowGetters || value._allowGetters;
            if (this._allowSetters || value._allowSetters) {
                z2 = true;
            }
            return construct(_merge2, z3, z4, z2, true);
        }
