...
public final class ApolloGenericException extends ApolloException {
    ...
    public ApolloGenericException(@Nullable String str, @Nullable Throwable th) {
        super(str, th);
    }

    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ ApolloGenericException(String str, Throwable th, int i3, DefaultConstructorMarker defaultConstructorMarker) {
