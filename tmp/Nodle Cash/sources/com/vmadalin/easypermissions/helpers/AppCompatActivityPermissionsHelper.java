...
public final class AppCompatActivityPermissionsHelper extends PermissionsHelper<AppCompatActivity> {
    ...
    public void showRequestPermissionRationale(@NotNull PermissionRequest permissionRequest) {
        ...
        new RationaleDialog((Context) getHost(), permissionRequest).showCompatDialog();
    }
}
