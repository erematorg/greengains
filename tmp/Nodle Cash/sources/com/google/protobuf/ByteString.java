...
public abstract class ByteString implements Iterable<Byte>, Serializable {
    ...
    public static abstract class LeafByteString extends ByteString {
        ...
        public abstract boolean equalsRange(ByteString byteString, int i3, int i4);
    ...
    public static void checkIndex(int i3, int i4) {
        ...
        throw new ArrayIndexOutOfBoundsException(androidx.compose.animation.core.a.r("Index > length: ", i3, ", ", i4));
    }
    ...
    private static int extractHexDigit(String str, int i3) {
        ...
        StringBuilder w2 = android.support.v4.media.session.a.w("Invalid hexString ", str, " must only contain [0-9a-fA-F] but contained ");
        w2.append(str.charAt(i3));
        w2.append(" at index ");
        w2.append(i3);
        throw new NumberFormatException(w2.toString());
    }
    ...
    public static ByteString fromHex(@CompileTimeConstant String str) {
        ...
        StringBuilder w2 = android.support.v4.media.session.a.w("Invalid hexString ", str, " of length ");
        w2.append(str.length());
        w2.append(" must be even.");
        throw new NumberFormatException(w2.toString());
    }
    ...
    public static CodedBuilder newCodedBuilder(int i3) {
    ...
    private static ByteString readChunk(InputStream inputStream, int i3) throws IOException {
        byte[] bArr = new byte[i3];
        int i4 = 0;
        while (i4 < i3) {
    ...
    public static ByteString readFrom(InputStream inputStream, int i3, int i4) throws IOException {
    ...
    public static final class Output extends OutputStream {
        ...
        private void flushLastBuffer() {
            ...
            if (i3 >= bArr.length) {
                ...
                this.flushedBuffers.add(new LiteralByteString(Arrays.copyOf(bArr, i3)));
            }
    ...
    public static ByteString wrap(byte[] bArr, int i3, int i4) {
    ...
    public final String toString() {
        ...
        int size = size();
        return a.n(android.support.v4.media.session.a.x("<ByteString@", hexString, " size=", size, " contents=\""), truncateAndEscapeForDisplay(), "\">");
    }
    ...
    public static ByteString copyFrom(Iterable<ByteString> iterable) {
        ...
        return balancedConcat(iterable.iterator(), i3);
    }
}
