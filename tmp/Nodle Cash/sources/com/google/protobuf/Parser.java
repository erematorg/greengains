...
public interface Parser<MessageType> {
    ...
    MessageType parseFrom(byte[] bArr, int i3, int i4, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException;
    ...
    MessageType parsePartialFrom(byte[] bArr, int i3, int i4, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException;
