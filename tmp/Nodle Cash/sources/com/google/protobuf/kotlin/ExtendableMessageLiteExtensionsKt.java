...
public final class ExtendableMessageLiteExtensionsKt {
    public static final <M extends GeneratedMessageLite.ExtendableMessage<M, ?>, MorBT extends GeneratedMessageLite.ExtendableMessageOrBuilder<M, ?>> boolean contains(@NotNull MorBT morbt, @NotNull ExtensionLite<M, ?> extensionLite) {
        ...
        Intrinsics.checkNotNullParameter(extensionLite, SchemaSymbols.ATTVAL_EXTENSION);
    ...
    public static final <M extends GeneratedMessageLite.ExtendableMessage<M, ?>, MOrBT extends GeneratedMessageLite.ExtendableMessageOrBuilder<M, ?>, T> T get(@NotNull MOrBT morbt, @NotNull ExtensionLite<M, T> extensionLite) {
        Intrinsics.checkNotNullParameter(morbt, "<this>");
        Intrinsics.checkNotNullParameter(extensionLite, SchemaSymbols.ATTVAL_EXTENSION);
        T extension = morbt.getExtension(extensionLite);
        Intrinsics.checkNotNullExpressionValue(extension, "getExtension(extension)");
        return extension;
    }

    public static final <M extends GeneratedMessageLite.ExtendableMessage<M, B>, B extends GeneratedMessageLite.ExtendableBuilder<M, B>, T> void set(@NotNull B b3, @NotNull ExtensionLite<M, T> extensionLite, @NotNull T t2) {
        Intrinsics.checkNotNullParameter(b3, "<this>");
        Intrinsics.checkNotNullParameter(extensionLite, SchemaSymbols.ATTVAL_EXTENSION);
        Intrinsics.checkNotNullParameter(t2, "value");
        b3.setExtension(extensionLite, t2);
    }
}
