...
public enum CharacterSetECI {
    ...
    private CharacterSetECI(int i3) {
        this(r2, r3, new int[]{i3}, new String[0]);
    }
    ...
    public static CharacterSetECI getCharacterSetECIByValue(int i3) throws FormatException {
        if (i3 >= 0 && i3 < 900) {
            return VALUE_TO_ECI.get(Integer.valueOf(i3));
        }
    ...
    private CharacterSetECI(int i3, String... strArr) {
