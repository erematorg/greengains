...
public final class HybridBinarizer extends GlobalHistogramBinarizer {
    ...
    private static void calculateThresholdForBlock(byte[] bArr, int i3, int i4, int i5, int i6, int[][] iArr, BitMatrix bitMatrix) {
        ...
        for (int i11 = 0; i11 < i8; i11++) {
            ...
            int cap = cap(i11, i8 - 3);
            for (int i14 = 0; i14 < i7; i14++) {
                int i15 = i14 << 3;
                int i16 = i15 > i10 ? i10 : i15;
                int cap2 = cap(i14, i7 - 3);
                int i17 = 0;
                for (int i18 = -2; i18 <= 2; i18++) {
                    int[] iArr2 = iArr[cap + i18];
                    i17 += iArr2[cap2 - 2] + iArr2[cap2 - 1] + iArr2[cap2] + iArr2[cap2 + 1] + iArr2[2 + cap2];
                }
                thresholdBlock(bArr, i16, i13, i17 / 25, i5, bitMatrix);
            }
        }
    }
    ...
    public BitMatrix getBlackMatrix() throws NotFoundException {
        ...
        if (width < 40 || height < 40) {
            ...
            int i6 = i5;
            int[][] calculateBlackPoints = calculateBlackPoints(matrix2, i4, i6, width, height);
            BitMatrix bitMatrix2 = new BitMatrix(width, height);
            calculateThresholdForBlock(matrix2, i4, i6, width, height, calculateBlackPoints, bitMatrix2);
