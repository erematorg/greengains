...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{385}, "HR");
            add(new int[]{387}, "BA");
            add(new int[]{Constants.MINIMAL_ERROR_STATUS_CODE, 440}, "DE");
            ...
            add(new int[]{JsonRpc2_0ZkSync.DEFAULT_BLOCK_COMMIT_TIME, 839}, "IT");
            ...
            add(new int[]{893}, "VN");
            add(new int[]{896}, "PK");
            add(new int[]{899}, SchemaSymbols.ATTVAL_ID);
    ...
    public String lookupCountryIdentifier(String str) {
        ...
        for (int i4 = 0; i4 < size && parseInt >= (i3 = iArr[0]); i4++) {
            if ((iArr = this.ranges.get(i4)).length != 1) {
                i3 = iArr[1];
            }
            if (parseInt <= i3) {
