...
public final class Stats implements Serializable {
    ...
    public String toString() {
        return count() > 0 ? MoreObjects.toStringHelper((Object) this).add("count", this.count).add("mean", this.mean).add("populationStandardDeviation", populationStandardDeviation()).add("min", this.min).add("max", this.max).toString() : MoreObjects.toStringHelper((Object) this).add("count", this.count).toString();
    }
    ...
    public static double meanOf(Iterator<? extends Number> it) {
        ...
        while (it.hasNext()) {
            ...
            if (!Doubles.isFinite(doubleValue2) || !Doubles.isFinite(doubleValue)) {
                ...
                doubleValue = ((doubleValue2 - doubleValue) / ((double) j2)) + doubleValue;
            }
        }
        return doubleValue;
    }
    ...
    public static double meanOf(double... dArr) {
        ...
        for (int i3 = 1; i3 < dArr.length; i3++) {
            ...
            if (!Doubles.isFinite(d3) || !Doubles.isFinite(d2)) {
                d2 = StatsAccumulator.calculateNewMeanNonFinite(d2, d3);
            } else {
                d2 = ((d3 - d2) / ((double) (i3 + 1))) + d2;
            }
        }
        return d2;
    }
