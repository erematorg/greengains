...
import com.appsamurai.storyly.exoplayer2.extractor.extractor.mp4.b;
...
public final class MediaType {
    ...
    public static final MediaType HTML_UTF_8 = createConstantUtf8("text", Method.HTML);
    ...
    private static final Joiner.MapJoiner PARAMETER_JOINER = Joiner.on("; ").withKeyValueSeparator(StickyVariantProvider.KEY_VALUE_DELIMITER);
    ...
    private String computeToString() {
        ...
        if (!this.parameters.isEmpty()) {
            sb.append("; ");
            PARAMETER_JOINER.appendTo(sb, (Iterable<? extends Map.Entry<?, ?>>) Multimaps.transformValues(this.parameters, new b(1)).entries());
        }
        return sb.toString();
    }

    private static void consumeSeparator(Tokenizer tokenizer, char c3) {
        CharMatcher charMatcher = LINEAR_WHITE_SPACE;
        tokenizer.consumeTokenIfPresent(charMatcher);
        tokenizer.consumeCharacter(c3);
        tokenizer.consumeTokenIfPresent(charMatcher);
    }
    ...
    private Map<String, ImmutableMultiset<String>> parametersAsMap() {
        return Maps.transformValues(this.parameters.asMap(), new b(2));
    }
    ...
    public static MediaType parse(String str) {
        ...
        try {
            ...
            consumeSeparator(tokenizer, JsonPointer.SEPARATOR);
            ...
            throw new IllegalArgumentException(a.l("Could not parse '", str, "'"), e3);
        }
    }
        ...
        if (optional == null) {
            ...
            while (it.hasNext()) {
                ...
                if (str == null) {
                    ...
                    throw new IllegalStateException(C0118y.f("Multiple charset values defined: ", str, ", ", str2));
                }
            }
    ...
    public static final class Tokenizer {
        ...
        @CanIgnoreReturnValue
        public char consumeCharacter(char c3) {
            Preconditions.checkState(hasMore());
