...
public final class CacheStats {
    ...
    public CacheStats(long j2, long j3, long j4, long j5, long j6, long j7) {
        ...
        Preconditions.checkArgument(j13 >= 0 ? true : z2);
        this.hitCount = j8;
        this.missCount = j9;
    ...
    public CacheStats minus(CacheStats cacheStats) {
        ...
        return new CacheStats(Math.max(0, LongMath.saturatedSubtract(this.hitCount, cacheStats2.hitCount)), Math.max(0, LongMath.saturatedSubtract(this.missCount, cacheStats2.missCount)), Math.max(0, LongMath.saturatedSubtract(this.loadSuccessCount, cacheStats2.loadSuccessCount)), Math.max(0, LongMath.saturatedSubtract(this.loadExceptionCount, cacheStats2.loadExceptionCount)), Math.max(0, LongMath.saturatedSubtract(this.totalLoadTime, cacheStats2.totalLoadTime)), Math.max(0, LongMath.saturatedSubtract(this.evictionCount, cacheStats2.evictionCount)));
    }
