...
public final class CacheBuilderSpec {
    ...
    public static class ConcurrencyLevelParser extends IntegerParser {
        public void parseInteger(CacheBuilderSpec cacheBuilderSpec, int i3) {
            Integer num = cacheBuilderSpec.concurrencyLevel;
            Preconditions.checkArgument(num == null, "concurrency level was already set to %s", (Object) num);
    ...
    public static abstract class DurationParser implements ValueParser {
        public void parse(CacheBuilderSpec cacheBuilderSpec, String str, @CheckForNull String str2) {
            ...
            if (!Strings.isNullOrEmpty(str2)) {
                ...
                throw new IllegalArgumentException(a.l("value of key ", str, " omitted"));
            }
        }
    ...
    public static class InitialCapacityParser extends IntegerParser {
        public void parseInteger(CacheBuilderSpec cacheBuilderSpec, int i3) {
            ...
            Preconditions.checkArgument(num == null, "initial capacity was already set to %s", (Object) num);
    ...
    public static abstract class IntegerParser implements ValueParser {
        ...
        public abstract void parseInteger(CacheBuilderSpec cacheBuilderSpec, int i3);
    }
    ...
    public static class KeyStrengthParser implements ValueParser {
        ...
        public void parse(CacheBuilderSpec cacheBuilderSpec, String str, @CheckForNull String str2) {
            ...
            Preconditions.checkArgument(z2, "%s was already set to %s", (Object) str, (Object) strength2);
    ...
    public static class MaximumSizeParser extends LongParser {
        public void parseLong(CacheBuilderSpec cacheBuilderSpec, long j2) {
            ...
            boolean z2 = false;
            Preconditions.checkArgument(l2 == null, "maximum size was already set to %s", (Object) l2);
            Long l3 = cacheBuilderSpec.maximumWeight;
            if (l3 == null) {
                z2 = true;
            }
            Preconditions.checkArgument(z2, "maximum weight was already set to %s", (Object) l3);
    ...
    public static class MaximumWeightParser extends LongParser {
        public void parseLong(CacheBuilderSpec cacheBuilderSpec, long j2) {
            ...
            boolean z2 = false;
            Preconditions.checkArgument(l2 == null, "maximum weight was already set to %s", (Object) l2);
            Long l3 = cacheBuilderSpec.maximumSize;
            if (l3 == null) {
                z2 = true;
            }
            Preconditions.checkArgument(z2, "maximum size was already set to %s", (Object) l3);
    ...
    public static CacheBuilderSpec parse(String str) {
        ...
        if (!str.isEmpty()) {
            for (String next : KEYS_SPLITTER.split(str)) {
                ...
                Preconditions.checkArgument(z2, "unknown key %s", (Object) str2);
