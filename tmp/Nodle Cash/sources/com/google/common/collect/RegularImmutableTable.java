...
abstract class RegularImmutableTable<R, C, V> extends ImmutableTable<R, C, V> {
    ...
    public final class Values extends ImmutableList<V> {
        ...
        public V get(int i3) {
            return RegularImmutableTable.this.getValue(i3);
        }
    ...
    public final void checkNoDuplicate(R r2, C c3, @CheckForNull V v2, V v3) {
        Preconditions.checkArgument(v2 == null, "Duplicate key: (row=%s, column=%s), values: [%s, %s].", r2, c3, v3, v2);
    }

    public abstract Table.Cell<R, C, V> getCell(int i3);
