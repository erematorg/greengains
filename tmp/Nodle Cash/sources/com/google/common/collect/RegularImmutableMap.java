...
final class RegularImmutableMap<K, V> extends ImmutableMap<K, V> {
    ...
    public static class EntrySet<K, V> extends ImmutableSet<Map.Entry<K, V>> {
        ...
        public EntrySet(ImmutableMap<K, V> immutableMap, Object[] objArr, int i3, int i4) {
    ...
    public static final class KeysOrValuesAsList extends ImmutableList<Object> {
        ...
        public KeysOrValuesAsList(Object[] objArr, int i3, int i4) {
            this.alternatingKeysAndValues = objArr;
            this.offset = i3;
            this.size = i4;
        }
    ...
    public static <K, V> RegularImmutableMap<K, V> create(int i3, Object[] objArr) {
        return create(i3, objArr, (ImmutableMap.Builder) null);
    }
    ...
    @CheckForNull
    public static Object createHashTableOrThrow(Object[] objArr, int i3, int i4, int i5) {
    ...
    public V get(@CheckForNull Object obj) {
        V v2 = get(this.hashTable, this.alternatingKeysAndValues, this.size, 0, obj);
        if (v2 == null) {
            return null;
        }
        return v2;
    ...
    public static <K, V> RegularImmutableMap<K, V> create(int i3, Object[] objArr, ImmutableMap.Builder<K, V> builder) {
        if (i3 == 0) {
    ...
    @CheckForNull
    public static Object get(@CheckForNull Object obj, Object[] objArr, int i3, int i4, @CheckForNull Object obj2) {
        if (obj2 == null) {
            return null;
        }
        if (i3 == 1) {
            ...
            if (obj instanceof byte[]) {
                ...
                while (true) {
                    ...
                    short s3 = sArr[i6] & 65535;
                    if (s3 == 65535) {
                        return null;
                    }
                    if (obj2.equals(objArr[s3])) {
                        return objArr[s3 ^ 1];
                    }
                    smear2 = i6 + 1;
                }
