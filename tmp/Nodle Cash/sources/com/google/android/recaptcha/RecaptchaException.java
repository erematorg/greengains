...
public final class RecaptchaException extends Exception {
    ...
    public /* synthetic */ RecaptchaException(@NonNull RecaptchaErrorCode recaptchaErrorCode, @NonNull String str, int i3, @NonNull DefaultConstructorMarker defaultConstructorMarker) {
