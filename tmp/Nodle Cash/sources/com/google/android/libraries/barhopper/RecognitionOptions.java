...
public class RecognitionOptions {
    ...
    public void setBarcodeFormats(int i3) {
    ...
    public void setMultiScaleDecodingOptions(@NonNull MultiScaleDecodingOptions multiScaleDecodingOptions2) {
        this.multiScaleDecodingOptions = multiScaleDecodingOptions2;
    }

    public void setMultiScaleDetectionOptions(@NonNull MultiScaleDetectionOptions multiScaleDetectionOptions2) {
        this.multiScaleDetectionOptions = multiScaleDetectionOptions2;
    }

    public void setOnedRecognitionOptions(@NonNull OnedRecognitionOptions onedRecognitionOptions2) {
