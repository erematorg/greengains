...
public interface ICameraUpdateFactoryDelegate extends IInterface {
    ...
    @NonNull
    IObjectWrapper newLatLngBounds(@NonNull LatLngBounds latLngBounds, int i3) throws RemoteException;

    @NonNull
    IObjectWrapper newLatLngBoundsWithSize(@NonNull LatLngBounds latLngBounds, int i3, int i4, int i5) throws RemoteException;
    ...
    @NonNull
    IObjectWrapper zoomByWithFocus(float f2, int i3, int i4) throws RemoteException;
