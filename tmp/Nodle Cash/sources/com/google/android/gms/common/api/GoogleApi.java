...
public abstract class GoogleApi<O extends Api.ApiOptions> implements HasApiKey<O> {
    ...
    public GoogleApi(@NonNull Activity activity, @NonNull Api<O> api, @NonNull O o3, @NonNull Settings settings) {
        this((Context) activity, activity, (Api) api, (Api.ApiOptions) o3, settings);
    }

    private final BaseImplementation.ApiMethodImpl zad(int i3, @NonNull BaseImplementation.ApiMethodImpl apiMethodImpl) {
        apiMethodImpl.zak();
        this.zaa.zau(this, i3, apiMethodImpl);
        return apiMethodImpl;
    }

    private final Task zae(int i3, @NonNull TaskApiCall taskApiCall) {
    ...
    @KeepForSdk
    @Deprecated
    public <A extends Api.AnyClient, T extends RegisterListenerMethod<A, ?>, U extends UnregisterListenerMethod<A, ?>> Task<Void> doRegisterEventListener(@NonNull T t2, @NonNull U u3) {
        ...
        return this.zaa.zao(this, t2, u3, zad.zaa);
    }
    ...
    @NonNull
    @KeepForSdk
    public Task<Boolean> doUnregisterEventListener(@NonNull ListenerHolder.ListenerKey<?> listenerKey, int i3) {
    ...
    public GoogleApi(@NonNull Context context, @NonNull Api<O> api, @NonNull O o3, @NonNull Settings settings) {
        this(context, (Activity) null, (Api) api, (Api.ApiOptions) o3, settings);
    }
