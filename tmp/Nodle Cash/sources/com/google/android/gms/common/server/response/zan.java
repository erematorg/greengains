...
public final class zan extends AbstractSafeParcelable {
    ...
    public zan(@SafeParcelable.Param(id = 1) int i3, @SafeParcelable.Param(id = 2) ArrayList arrayList, @SafeParcelable.Param(id = 3) String str) {
        this.zaa = i3;
        HashMap hashMap = new HashMap();
        int size = arrayList.size();
        for (int i4 = 0; i4 < size; i4++) {
            zal zal = (zal) arrayList.get(i4);
            String str2 = zal.zab;
            HashMap hashMap2 = new HashMap();
            int size2 = ((ArrayList) Preconditions.checkNotNull(zal.zac)).size();
            for (int i5 = 0; i5 < size2; i5++) {
                zam zam = (zam) zal.zac.get(i5);
