...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    public ConnectionResult(@SafeParcelable.Param(id = 1) int i3, @SafeParcelable.Param(id = 2) int i4, @SafeParcelable.Param(id = 3) @Nullable PendingIntent pendingIntent, @SafeParcelable.Param(id = 4) @Nullable String str) {
        this.zza = i3;
        this.zzb = i4;
        ...
        switch (i3) {
            ...
            default:
                switch (i3) {
                    ...
                    default:
                        return C0118y.c(i3, "UNKNOWN_ERROR_CODE(", ")");
                }
        }
    }
    ...
    public String toString() {
        ...
        stringHelper.add(PushMessagingService.KEY_MESSAGE, this.zzd);
    ...
    public ConnectionResult(int i3, @Nullable PendingIntent pendingIntent) {
        this(i3, pendingIntent, (String) null);
    }

    public ConnectionResult(int i3, @Nullable PendingIntent pendingIntent, @Nullable String str) {
