...
public class GoogleApiManager implements Handler.Callback {
    ...
    public static Status zaF(ApiKey apiKey, ConnectionResult connectionResult) {
        return new Status(connectionResult, C0118y.f("API: ", apiKey.zaa(), " is not available on this device. Connection failed with: ", String.valueOf(connectionResult)));
    }
    ...
    private final void zaJ(TaskCompletionSource taskCompletionSource, int i3, GoogleApi googleApi) {
        zacd zaa2;
            ...
            case 5:
                ...
                if (zabq != null) {
                    if (connectionResult.getErrorCode() != 13) {
                        ...
                        zabq.zaE(new Status(17, C0118y.f("Error resolution was canceled by the user, original error message: ", this.zaj.getErrorString(connectionResult.getErrorCode()), ": ", connectionResult.getErrorMessage())));
                        break;
                    }
                } else {
                    Log.wtf("GoogleApiManager", C0118y.c(i4, "Could not find API instance ", " while trying to fail enqueued calls."), new Exception());
                    break;
                }
            case 6:
    ...
    @ResultIgnorabilityUnspecified
    public final boolean zaE(ConnectionResult connectionResult, int i3) {
        return this.zaj.zah(this.zai, connectionResult, i3);
    }
    ...
    @NonNull
    public final Task zap(@NonNull GoogleApi googleApi, @NonNull ListenerHolder.ListenerKey listenerKey, int i3) {
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
        zaJ(taskCompletionSource, i3, googleApi);
        this.zar.sendMessage(this.zar.obtainMessage(13, new zach(new zah(listenerKey, taskCompletionSource), this.zam.get(), googleApi)));
        return taskCompletionSource.getTask();
    }

    public final void zau(@NonNull GoogleApi googleApi, int i3, @NonNull BaseImplementation.ApiMethodImpl apiMethodImpl) {
        this.zar.sendMessage(this.zar.obtainMessage(4, new zach(new zae(i3, apiMethodImpl), this.zam.get(), googleApi)));
    }

    public final void zav(@NonNull GoogleApi googleApi, int i3, @NonNull TaskApiCall taskApiCall, @NonNull TaskCompletionSource taskCompletionSource, @NonNull StatusExceptionMapper statusExceptionMapper) {
        zaJ(taskCompletionSource, taskApiCall.zaa(), googleApi);
        this.zar.sendMessage(this.zar.obtainMessage(4, new zach(new zag(i3, taskApiCall, taskCompletionSource, statusExceptionMapper), this.zam.get(), googleApi)));
    }

    public final void zaw(MethodInvocation methodInvocation, int i3, long j2, int i4) {
        this.zar.sendMessage(this.zar.obtainMessage(18, new zace(methodInvocation, i3, j2, i4)));
    }

    public final void zax(@NonNull ConnectionResult connectionResult, int i3) {
        if (!zaE(connectionResult, i3)) {
            Handler handler = this.zar;
