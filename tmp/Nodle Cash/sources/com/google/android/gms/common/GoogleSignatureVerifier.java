...
public class GoogleSignatureVerifier {
    ...
    public static final zzj zza(PackageInfo packageInfo, zzj... zzjArr) {
        ...
        if (signatureArr != null) {
            ...
            for (int i3 = 0; i3 < zzjArr.length; i3++) {
                if (zzjArr[i3].equals(zzk)) {
                    return zzjArr[i3];
                }
            }
        }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private final com.google.android.gms.common.zzx zzc(@javax.annotation.Nullable java.lang.String r6, boolean r7, boolean r8) {
        /*
            r5 = this;
    ...
    public boolean isUidGoogleSigned(int i3) {
        ...
        if (packagesForUid != null && (length = packagesForUid.length) != 0) {
            ...
            while (true) {
                ...
                zzx = zzc(packagesForUid[i4], false, false);
                if (zzx.zza) {
                    break;
                }
                i4++;
