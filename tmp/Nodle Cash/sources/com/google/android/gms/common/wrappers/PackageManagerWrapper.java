...
public class PackageManagerWrapper {
    ...
    @NonNull
    @KeepForSdk
    public ApplicationInfo getApplicationInfo(@NonNull String str, int i3) throws PackageManager.NameNotFoundException {
    ...
    @NonNull
    @KeepForSdk
    public PackageInfo getPackageInfo(@NonNull String str, int i3) throws PackageManager.NameNotFoundException {
    ...
    @TargetApi(19)
    public final boolean zza(int i3, @NonNull String str) {
