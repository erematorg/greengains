...
public final class zac {
    ...
    public static String zab(Context context, int i3) {
        ...
        return i3 != 1 ? i3 != 2 ? i3 != 3 ? resources.getString(17039370) : resources.getString(R.string.common_google_play_services_enable_button) : resources.getString(R.string.common_google_play_services_update_button) : resources.getString(R.string.common_google_play_services_install_button);
    }
    ...
    public static String zac(Context context, int i3) {
        ...
        if (i3 == 2) {
            return DeviceProperties.isWearableWithoutPlayStore(context) ? resources.getString(R.string.common_google_play_services_wear_update_text) : resources.getString(R.string.common_google_play_services_update_text, new Object[]{zaa2});
        }
        if (i3 == 3) {
    ...
    public static String zae(Context context, int i3) {
        String zah = i3 == 6 ? zah(context, "common_google_play_services_resolution_required_title") : zaf(context, i3);
