...
public class ConnectionTracker {
    ...
    private final boolean zzc(Context context, String str, Intent intent, ServiceConnection serviceConnection, int i3, boolean z2, @Nullable Executor executor) {
    ...
    private static final boolean zze(Context context, Intent intent, ServiceConnection serviceConnection, int i3, @Nullable Executor executor) {
        ...
        return (!PlatformVersion.isAtLeastQ() || executor == null) ? context.bindService(intent, serviceConnection, i3) : context.bindService(intent, i3, executor, serviceConnection);
    }

    @ResultIgnorabilityUnspecified
    @KeepForSdk
    public boolean bindService(@NonNull Context context, @NonNull Intent intent, @NonNull ServiceConnection serviceConnection, int i3) {
        return zzc(context, context.getClass().getName(), intent, serviceConnection, i3, true, (Executor) null);
    }
    ...
    @ResultIgnorabilityUnspecified
    public final boolean zza(@NonNull Context context, @NonNull String str, @NonNull Intent intent, @NonNull ServiceConnection serviceConnection, int i3, @Nullable Executor executor) {
