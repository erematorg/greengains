...
public class RegisterRequest extends AbstractSafeParcelable {
    ...
    public RegisterRequest(@SafeParcelable.Param(id = 1) int i3, @SafeParcelable.Param(id = 2) String str, @SafeParcelable.Param(id = 3) byte[] bArr, @SafeParcelable.Param(id = 4) String str2) {
        this.zza = i3;
        try {
