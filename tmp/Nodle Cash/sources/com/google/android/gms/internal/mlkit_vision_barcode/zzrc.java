...
public enum zzrc implements zzfc {
    ...
    ACCELERATION_ANALYTICS(WindowsFindData.MAX_PATH),
    ...
    AGGREGATED_ON_DEVICE_SEGMENTATION(JNINativeInterface.SetByteArrayRegion),
    AGGREGATED_CUSTOM_OBJECT_INFERENCE(JNINativeInterface.SetCharArrayRegion),
    AGGREGATED_CUSTOM_IMAGE_LABEL_DETECTION(JNINativeInterface.SetShortArrayRegion),
    AGGREGATED_ON_DEVICE_EXPLICIT_CONTENT_DETECTION(211),
    AGGREGATED_ON_DEVICE_FACE_MESH_DETECTION(JNINativeInterface.SetLongArrayRegion),
    AGGREGATED_ON_DEVICE_IMAGE_QUALITY_ANALYSIS_DETECTION(JNINativeInterface.SetFloatArrayRegion),
    AGGREGATED_ON_DEVICE_IMAGE_CAPTIONING_INFERENCE(JNINativeInterface.SetDoubleArrayRegion),
    AGGREGATED_ON_DEVICE_DOCUMENT_DETECT_PROCESS(JNINativeInterface.RegisterNatives),
    AGGREGATED_ON_DEVICE_DOCUMENT_CROP_PROCESS(JNINativeInterface.UnregisterNatives),
    AGGREGATED_ON_DEVICE_DOCUMENT_ENHANCE_PROCESS(JNINativeInterface.MonitorEnter),
    AGGREGATED_ON_DEVICE_STAIN_REMOVAL_PROCESS(JNINativeInterface.MonitorExit),
    AGGREGATED_ON_DEVICE_SHADOW_REMOVAL_PROCESS(JNINativeInterface.GetJavaVM),
    AGGREGATED_ON_DEVICE_SUBJECT_SEGMENTATION_INFERENCE(JNINativeInterface.GetStringRegion),
    ...
    INSTALLATION_ID_REGISTER_NEW_ID(FileStat.ALL_READ),
