...
interface zzna {
    ...
    <T> void zza(T t2, zznd<T> zznd, zzkp zzkp) throws IOException;

    void zza(List<Boolean> list) throws IOException;

    @Deprecated
    <T> void zza(List<T> list, zznd<T> zznd, zzkp zzkp) throws IOException;

    <K, V> void zza(Map<K, V> map, zzmc<K, V> zzmc, zzkp zzkp) throws IOException;

    float zzb() throws IOException;

    <T> void zzb(T t2, zznd<T> zznd, zzkp zzkp) throws IOException;

    void zzb(List<zzjs> list) throws IOException;

    <T> void zzb(List<T> list, zznd<T> zznd, zzkp zzkp) throws IOException;
