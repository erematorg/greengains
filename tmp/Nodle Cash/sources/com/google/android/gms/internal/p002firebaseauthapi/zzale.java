...
interface zzale {
    ...
    <T> void zza(T t2, zzalh<T> zzalh, zzaiq zzaiq) throws IOException;

    void zza(List<Boolean> list) throws IOException;

    @Deprecated
    <T> void zza(List<T> list, zzalh<T> zzalh, zzaiq zzaiq) throws IOException;

    <K, V> void zza(Map<K, V> map, zzakg<K, V> zzakg, zzaiq zzaiq) throws IOException;

    float zzb() throws IOException;

    <T> void zzb(T t2, zzalh<T> zzalh, zzaiq zzaiq) throws IOException;

    void zzb(List<zzaho> list) throws IOException;

    <T> void zzb(List<T> list, zzalh<T> zzalh, zzaiq zzaiq) throws IOException;
