...
final class zzfg implements ObjectEncoderContext {
    ...
    private static final FieldDescriptor zzb = a.o(1, FieldDescriptor.builder(JwtUtilsKt.DID_METHOD_KEY));
    private static final FieldDescriptor zzc = a.o(2, FieldDescriptor.builder("value"));
    ...
    public final zzfg zzd(@NonNull FieldDescriptor fieldDescriptor, int i3, boolean z2) throws IOException {
        if (!z2 || i3 != 0) {
    ...
    public final zzfg zze(@NonNull FieldDescriptor fieldDescriptor, long j2, boolean z2) throws IOException {
        if (!z2 || j2 != 0) {
            zzfe zzj = zzj(fieldDescriptor);
            int ordinal = zzj.zzb().ordinal();
            if (ordinal == 0) {
