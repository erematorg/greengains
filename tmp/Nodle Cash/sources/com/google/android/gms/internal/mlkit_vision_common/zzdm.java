...
final class zzdm implements ObjectEncoder {
    ...
    private static final FieldDescriptor zzb = a.q(1, FieldDescriptor.builder("supportedFormats"));
    ...
    private static final FieldDescriptor zze = a.q(4, FieldDescriptor.builder("allowManualInput"));
