...
final class zzak implements ObjectEncoderContext {
    ...
    private static final FieldDescriptor zzb = a.q(1, FieldDescriptor.builder(JwtUtilsKt.DID_METHOD_KEY));
    private static final FieldDescriptor zzc = a.q(2, FieldDescriptor.builder("value"));
    ...
    public final zzak zzd(@NonNull FieldDescriptor fieldDescriptor, int i3, boolean z2) throws IOException {
        if (z2 && i3 == 0) {
            return this;
        }
    ...
    public final zzak zze(@NonNull FieldDescriptor fieldDescriptor, long j2, boolean z2) throws IOException {
        if (z2 && j2 == 0) {
            return this;
        }
        zzai zzj = zzj(fieldDescriptor);
