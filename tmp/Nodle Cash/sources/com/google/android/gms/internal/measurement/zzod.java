...
final class zzod extends zzoe {
    ...
    public final String zza(byte[] bArr, int i3, int i4) throws zzlk {
            ...
            while (r10 < i5) {
                ...
                if (b4 >= 0) {
                    ...
                    if (i8 < i5 - 1) {
                        int i10 = r10 + 2;
                        r10 += 3;
                        zzob.zza(b4, bArr[i8], bArr[i10], cArr, i7);
                        i7++;
                    } else {
                        throw zzlk.zzd();
                    }
                    ...
                    byte b7 = bArr[r10 + 2];
                    r10 += 4;
                    zzob.zza(b4, b6, b7, bArr[i11], cArr, i7);
                    i7 += 2;
                } else {
                    throw zzlk.zzd();
                }
