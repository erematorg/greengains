...
class zzgv extends AbstractMap {
    ...
    public /* synthetic */ zzgv(int i3, zzgu zzgu) {
        this.zza = i3;
    }
    ...
    private final int zzk(Comparable comparable) {
        ...
        int i4 = 0;
        if (i3 >= 0) {
            int compareTo = comparable.compareTo(((zzgp) this.zzb.get(i3)).zza());
            if (compareTo > 0) {
                return -(size + 1);
            }
            if (compareTo == 0) {
        ...
        while (i4 <= i3) {
            int i5 = (i4 + i3) / 2;
            int compareTo2 = comparable.compareTo(((zzgp) this.zzb.get(i5)).zza());
            if (compareTo2 < 0) {
                i3 = i5 - 1;
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i4 = this.zza;
        if (size == i4) {
            zzgp zzgp = (zzgp) this.zzb.remove(i4 - 1);
