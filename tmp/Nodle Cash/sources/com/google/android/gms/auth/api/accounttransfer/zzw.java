...
public final class zzw extends zzbz {
    ...
    public final Object getFieldValue(FastJsonResponse.Field field) {
        ...
        throw new IllegalStateException(a.k("Unknown SafeParcelable id=", field.getSafeParcelableFieldId()));
    }
    ...
    public final void setDecodedBytesInternal(FastJsonResponse.Field field, String str, byte[] bArr) {
        ...
        throw new IllegalArgumentException(C0118y.c(safeParcelableFieldId, "Field with id=", " is not known to be a byte array."));
    }

    public final void setIntegerInternal(FastJsonResponse.Field field, String str, int i3) {
        int safeParcelableFieldId = field.getSafeParcelableFieldId();
        if (safeParcelableFieldId == 3) {
            this.zze = i3;
            this.zza.add(Integer.valueOf(safeParcelableFieldId));
        ...
        throw new IllegalArgumentException(C0118y.c(safeParcelableFieldId, "Field with id=", " is not known to be an int."));
    }
    ...
    public zzw(@SafeParcelable.Indicator Set set, @SafeParcelable.Param(id = 1) int i3, @SafeParcelable.Param(id = 2) String str, @SafeParcelable.Param(id = 3) int i4, @SafeParcelable.Param(id = 4) byte[] bArr, @SafeParcelable.Param(id = 5) PendingIntent pendingIntent, @SafeParcelable.Param(id = 6) DeviceMetaData deviceMetaData) {
        this.zza = set;
        this.zzb = i3;
        this.zzd = str;
        this.zze = i4;
