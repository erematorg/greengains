...
public class SavePasswordRequest extends AbstractSafeParcelable {
    ...
    public SavePasswordRequest(@SafeParcelable.Param(id = 1) SignInPassword signInPassword, @SafeParcelable.Param(id = 2) @Nullable String str, @SafeParcelable.Param(id = 3) int i3) {
