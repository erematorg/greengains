...
public class GoogleSignInOptionsExtensionParcelable extends AbstractSafeParcelable {
    ...
    public GoogleSignInOptionsExtensionParcelable(@SafeParcelable.Param(id = 1) int i3, @SafeParcelable.Param(id = 2) int i4, @SafeParcelable.Param(id = 3) Bundle bundle) {
        this.zaa = i3;
        this.zab = i4;
        this.zac = bundle;
    }
