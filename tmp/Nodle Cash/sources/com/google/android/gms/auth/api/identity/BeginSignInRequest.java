...
public final class BeginSignInRequest extends AbstractSafeParcelable {
    ...
    public static final class GoogleIdTokenRequestOptions extends AbstractSafeParcelable {
        ...
        public GoogleIdTokenRequestOptions(@SafeParcelable.Param(id = 1) boolean z2, @SafeParcelable.Param(id = 2) @Nullable String str, @SafeParcelable.Param(id = 3) @Nullable String str2, @SafeParcelable.Param(id = 4) boolean z3, @SafeParcelable.Param(id = 5) @Nullable String str3, @SafeParcelable.Param(id = 6) @Nullable List list, @SafeParcelable.Param(id = 7) boolean z4) {
            boolean z5 = true;
            if (z3 && z4) {
                z5 = false;
            }
    ...
    public static final class PasskeysRequestOptions extends AbstractSafeParcelable {
        ...
        public int hashCode() {
            return Arrays.hashCode(this.zbb) + (java.util.Objects.hash(new Object[]{Boolean.valueOf(this.zba), this.zbc}) * 31);
        }
