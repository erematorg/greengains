...
public final class GoogleAuthUtil extends zzl {
    ...
    @NonNull
    public static List<AccountChangeEvent> getAccountChangeEvents(@NonNull Context context, int i3, @NonNull String str) throws GoogleAuthException, IOException {
    ...
    private static TokenData zzg(Context context, Account account, String str, Bundle bundle, long j2) throws IOException, GoogleAuthException {
        try {
