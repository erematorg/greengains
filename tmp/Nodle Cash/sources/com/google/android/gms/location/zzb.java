...
public final class zzb extends AbstractSafeParcelable {
    ...
    public zzb(@SafeParcelable.Param(id = 1) long j2, @SafeParcelable.Param(id = 2) boolean z2, @SafeParcelable.Param(id = 3) @Nullable WorkSource workSource, @SafeParcelable.Param(id = 4) @Nullable String str, @SafeParcelable.Param(id = 5) @Nullable int[] iArr, @SafeParcelable.Param(id = 6) boolean z3, @SafeParcelable.Param(id = 7) @Nullable String str2, @SafeParcelable.Param(id = 8) long j3, @SafeParcelable.Param(id = 9) @Nullable String str3) {
        this.zza = j2;
        this.zzb = z2;
        this.zzc = workSource;
        this.zzd = str;
