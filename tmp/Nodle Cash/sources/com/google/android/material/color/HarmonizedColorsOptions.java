...
public class HarmonizedColorsOptions {
    ...
    public static class Builder {
        ...
        public Builder setColorAttributeToHarmonizeWith(@AttrRes int i3) {
            this.colorAttributeToHarmonizeWith = i3;
            return this;
        }
    ...
    @StyleRes
    public int getThemeOverlayResourceId(@StyleRes int i3) {
        HarmonizedColorAttributes harmonizedColorAttributes = this.colorAttributes;
        return (harmonizedColorAttributes == null || harmonizedColorAttributes.getThemeOverlay() == 0) ? i3 : this.colorAttributes.getThemeOverlay();
    }
