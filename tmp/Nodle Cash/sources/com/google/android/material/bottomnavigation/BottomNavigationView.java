...
public class BottomNavigationView extends NavigationBarView {
    ...
    private int makeMinHeightSpec(int i3) {
        ...
        return View.MeasureSpec.makeMeasureSpec(Math.min(View.MeasureSpec.getSize(i3), getPaddingBottom() + paddingTop + suggestedMinimumHeight), 1073741824);
    }
    ...
    public BottomNavigationView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i3, int i4) {
        ...
        TintTypedArray obtainTintedStyledAttributes = ThemeEnforcement.obtainTintedStyledAttributes(context2, attributeSet, R.styleable.BottomNavigationView, i3, i4, new int[0]);
        ...
        if (obtainTintedStyledAttributes.hasValue(i5)) {
            setMinimumHeight(obtainTintedStyledAttributes.getDimensionPixelSize(i5, 0));
        }
