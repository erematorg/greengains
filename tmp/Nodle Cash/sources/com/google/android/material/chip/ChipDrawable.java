...
public class ChipDrawable extends MaterialShapeDrawable implements TintAwareDrawable, Drawable.Callback, TextDrawableHelper.TextDrawableDelegate {
    ...
    private ChipDrawable(@NonNull Context context2, AttributeSet attributeSet, @AttrRes int i3, @StyleRes int i4) {
    ...
    private void calculateChipIconBounds(@NonNull Rect rect, @NonNull RectF rectF2) {
        ...
        if (showsChipIcon() || showsCheckedIcon()) {
            ...
            if (DrawableCompat.getLayoutDirection(this) == 0) {
                ...
                rectF2.left = f3;
                rectF2.right = f3 + currentChipIconWidth;
            } else {
                float f4 = ((float) rect.right) - f2;
                rectF2.right = f4;
                rectF2.left = f4 - currentChipIconWidth;
            }
    ...
    private void calculateCloseIconTouchBounds(@NonNull Rect rect, @NonNull RectF rectF2) {
        ...
        if (showsCloseIcon()) {
            ...
            if (DrawableCompat.getLayoutDirection(this) == 0) {
                ...
                int i3 = rect.left;
                rectF2.left = (float) i3;
                rectF2.right = ((float) i3) + f2;
            }
    ...
    @NonNull
    public static ChipDrawable createFromAttributes(@NonNull Context context2, @Nullable AttributeSet attributeSet, @AttrRes int i3, @StyleRes int i4) {
        ChipDrawable chipDrawable = new ChipDrawable(context2, attributeSet, i3, i4);
        chipDrawable.loadFromAttributes(attributeSet, i3, i4);
        return chipDrawable;
    }

    @NonNull
    public static ChipDrawable createFromResource(@NonNull Context context2, @XmlRes int i3) {
        AttributeSet parseDrawableXml = DrawableUtils.parseDrawableXml(context2, i3, "chip");
    ...
    private void drawChipStroke(@NonNull Canvas canvas, @NonNull Rect rect) {
        if (this.chipStrokeWidth > 0.0f && !this.isShapeThemingEnabled) {
            ...
            rectF2.set((f2 / 2.0f) + ((float) rect.left), (f2 / 2.0f) + ((float) rect.top), ((float) rect.right) - (f2 / 2.0f), ((float) rect.bottom) - (f2 / 2.0f));
    ...
    private void loadFromAttributes(@Nullable AttributeSet attributeSet, @AttrRes int i3, @StyleRes int i4) {
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(this.context, attributeSet, R.styleable.Chip, i3, i4, new int[0]);
        ...
        if (obtainStyledAttributes.hasValue(i7)) {
            setChipIconTint(MaterialResources.getColorStateList(this.context, obtainStyledAttributes, i7));
        }
        ...
        if (obtainStyledAttributes.hasValue(i8)) {
            setCheckedIconTint(MaterialResources.getColorStateList(this.context, obtainStyledAttributes, i8));
        }
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        if (!bounds.isEmpty() && getAlpha() != 0) {
            int i4 = this.alpha;
            if (i4 < 255) {
                i3 = CanvasCompat.saveLayerAlpha(canvas, (float) bounds.left, (float) bounds.top, (float) bounds.right, (float) bounds.bottom, i4);
            } else {
                i3 = 0;
            }
    ...
    private boolean onStateChange(@NonNull int[] iArr, @NonNull int[] iArr2) {
        ...
        boolean z4 = hasState(getState(), 16842912) && this.checkable;
