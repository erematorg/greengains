...
public class MotionUtils {
    ...
    private static String getLegacyEasingContent(String str, String str2) {
        return b.y(str, 1, str2.length() + 1);
    }
    ...
    private static TimeInterpolator getLegacyThemeInterpolator(String str) {
        if (isLegacyEasingType(str, EASING_TYPE_CUBIC_BEZIER)) {
            ...
            throw new IllegalArgumentException(c.a("Invalid motion easing type: ", str));
        }
    }
    ...
    public static int resolveThemeDuration(@NonNull Context context, @AttrRes int i3, int i4) {
        return MaterialAttributes.resolveInteger(context, i3, i4);
    }

    @NonNull
    public static TimeInterpolator resolveThemeInterpolator(@NonNull Context context, @AttrRes int i3, @NonNull TimeInterpolator timeInterpolator) {
