...
class MaterialButtonHelper {
    ...
    private MaterialShapeDrawable getMaterialShapeDrawable(boolean z2) {
        ...
        if (IS_MIN_LOLLIPOP) {
            return (MaterialShapeDrawable) ((LayerDrawable) ((InsetDrawable) this.rippleDrawable.getDrawable(0)).getDrawable()).getDrawable(z2 ^ true ? 1 : 0);
        }
        return (MaterialShapeDrawable) this.rippleDrawable.getDrawable(z2 ^ true ? 1 : 0);
    }
    ...
    private void setVerticalInsets(@Dimension int i3, @Dimension int i4) {
        ...
        ViewCompat.setPaddingRelative(this.materialButton, paddingStart, (paddingTop + i3) - i5, paddingEnd, (paddingBottom + i4) - i6);
    }
    ...
    public void setCornerRadius(int i3) {
        if (!this.cornerRadiusSet || this.cornerRadius != i3) {
            ...
            this.cornerRadiusSet = true;
            setShapeAppearanceModel(this.shapeAppearanceModel.withCornerSize((float) i3));
        }
    }
    ...
    public void setRippleColor(@Nullable ColorStateList colorStateList) {
        if (this.rippleColor != colorStateList) {
            ...
            } else if (!z2 && (this.materialButton.getBackground() instanceof RippleDrawableCompat)) {
