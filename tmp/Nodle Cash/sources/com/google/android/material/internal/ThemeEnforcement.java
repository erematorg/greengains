...
public final class ThemeEnforcement {
    ...
    private static void checkCompatibleTheme(@NonNull Context context, AttributeSet attributeSet, @AttrRes int i3, @StyleRes int i4) {
    ...
    private static void checkTextAppearance(@NonNull Context context, AttributeSet attributeSet, @StyleableRes @NonNull int[] iArr, @AttrRes int i3, @StyleRes int i4, @StyleableRes @Nullable int... iArr2) {
        boolean z2;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.ThemeEnforcement, i3, i4);
        boolean z3 = false;
        ...
        if (iArr2 == null || iArr2.length == 0) {
            ...
            z2 = isCustomTextAppearanceValid(context, attributeSet, iArr, i3, i4, iArr2);
        }
        obtainStyledAttributes.recycle();
        if (!z2) {
    ...
    private static boolean isCustomTextAppearanceValid(@NonNull Context context, AttributeSet attributeSet, @StyleableRes @NonNull int[] iArr, @AttrRes int i3, @StyleRes int i4, @StyleableRes @NonNull int... iArr2) {
    ...
    @NonNull
    public static TypedArray obtainStyledAttributes(@NonNull Context context, AttributeSet attributeSet, @StyleableRes @NonNull int[] iArr, @AttrRes int i3, @StyleRes int i4, @StyleableRes int... iArr2) {
    ...
    public static TintTypedArray obtainTintedStyledAttributes(@NonNull Context context, AttributeSet attributeSet, @StyleableRes @NonNull int[] iArr, @AttrRes int i3, @StyleRes int i4, @StyleableRes int... iArr2) {
        checkCompatibleTheme(context, attributeSet, i3, i4);
        checkTextAppearance(context, attributeSet, iArr, i3, i4, iArr2);
