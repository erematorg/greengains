...
public class CircularRevealHelper {
    ...
    private void drawDebugCircle(@NonNull Canvas canvas, int i3, float f2) {
        this.debugPaint.setColor(i3);
        this.debugPaint.setStrokeWidth(f2);
        CircularRevealWidget.RevealInfo revealInfo2 = this.revealInfo;
        canvas.drawCircle(revealInfo2.centerX, revealInfo2.centerY, revealInfo2.radius - (f2 / 2.0f), this.debugPaint);
    }
    ...
    public void draw(@NonNull Canvas canvas) {
        if (shouldDrawCircularReveal()) {
            ...
            if (i3 == 0) {
                ...
                throw new IllegalStateException(a.k("Unsupported strategy ", i3));
            }
        } else {
            this.delegate.actualDraw(canvas);
            if (shouldDrawScrim()) {
