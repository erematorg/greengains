...
public class SearchBar extends Toolbar {
    ...
    private ColorStateList getCompatBackgroundColorStateList(@ColorInt int i3, @ColorInt int i4) {
        int layer = MaterialColors.layer(i3, i4);
        return new ColorStateList(new int[][]{new int[]{16842919}, new int[]{16842908}, new int[0]}, new int[]{layer, layer, i3});
    }

    private void initBackground(ShapeAppearanceModel shapeAppearanceModel, @ColorInt int i3, float f2, float f3, @ColorInt int i4) {
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(shapeAppearanceModel);
        this.backgroundShape = materialShapeDrawable;
        materialShapeDrawable.initializeElevationOverlay(getContext());
        this.backgroundShape.setElevation(f2);
        if (f3 >= 0.0f) {
            this.backgroundShape.setStroke(f3, i4);
        }
    ...
    private void initTextView(@StyleRes int i3, String str, String str2) {
        if (i3 != -1) {
    ...
    private Drawable maybeTintNavigationIcon(@Nullable Drawable drawable) {
        ...
        if (num != null) {
            ...
            i3 = MaterialColors.getColor(this, drawable == this.defaultNavigationIcon ? R.attr.colorOnSurfaceVariant : R.attr.colorOnSurface);
        }
    ...
    private void setHandwritingBoundsInsets() {
        if (Build.VERSION.SDK_INT >= 34) {
            ...
            if (actionMenuView != null) {
                i3 = z2 ? actionMenuView.getRight() : getWidth() - actionMenuView.getLeft();
            }
            float f2 = (float) (-(z2 ? i3 : width));
            if (!z2) {
                width = i3;
            }
