...
public final class MaterialContainerTransform extends Transition {
    ...
    public static final class TransitionDrawable extends Drawable {
        ...
        private void updateProgress(float f2) {
            ...
            this.motionPathMeasure.getPosTan(this.motionPathLength * f2, this.motionPathPosition, (float[]) null);
            ...
            rectF2.set(f9 - (f12 / 2.0f), f10, (f12 / 2.0f) + f9, fitModeResult2.currentEndHeight + f10);
        ...
        private TransitionDrawable(PathMotion pathMotion, View view, RectF rectF, ShapeAppearanceModel shapeAppearanceModel, float f2, View view2, RectF rectF2, ShapeAppearanceModel shapeAppearanceModel2, float f3, @ColorInt int i3, @ColorInt int i4, @ColorInt int i5, int i6, boolean z2, boolean z3, FadeModeEvaluator fadeModeEvaluator2, FitModeEvaluator fitModeEvaluator2, ProgressThresholdsGroup progressThresholdsGroup, boolean z4) {
            ...
            paint4.setShader(TransitionUtils.createColorShader(i6));
    ...
    private static void captureValues(@NonNull TransitionValues transitionValues, @Nullable View view, @IdRes int i3, @Nullable ShapeAppearanceModel shapeAppearanceModel) {
        if (i3 != -1) {
            ...
            if (view2.getTag(i4) instanceof View) {
                transitionValues.view.setTag(i4, (Object) null);
    ...
    private void maybeApplyThemeValues(Context context, boolean z2) {
        ...
        TransitionUtils.maybeApplyThemeDuration(this, context, z2 ? R.attr.motionDurationLong2 : R.attr.motionDurationMedium4);
    ...
    public Animator createAnimator(@NonNull ViewGroup viewGroup, @Nullable TransitionValues transitionValues, @Nullable TransitionValues transitionValues2) {
        ...
        if (!(transitionValues3 == null || transitionValues4 == null)) {
            ...
            if (rectF == null || shapeAppearanceModel == null) {
                ...
                RectF calculateDrawableBounds = calculateDrawableBounds(view, view2, f2, f3);
                rectF.offset(f2, f3);
                rectF2.offset(f2, f3);
