...
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget, Shapeable, CoordinatorLayout.AttachedBehavior {
    ...
    public class ShadowDelegateImpl implements ShadowViewDelegate {
        ...
        public void setShadowPadding(int i3, int i4, int i5, int i6) {
            FloatingActionButton.this.shadowPadding.set(i3, i4, i5, i6);
            FloatingActionButton floatingActionButton = FloatingActionButton.this;
            floatingActionButton.setPadding(floatingActionButton.imagePadding + i3, FloatingActionButton.this.imagePadding + i4, FloatingActionButton.this.imagePadding + i5, FloatingActionButton.this.imagePadding + i6);
        }
    }
    ...
    public void setImageResource(@DrawableRes int i3) {
        this.imageHelper.setImageResource(i3);
        onApplySupportImageTint();
    }
