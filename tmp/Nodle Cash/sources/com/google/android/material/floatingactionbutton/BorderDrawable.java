...
class BorderDrawable extends Drawable {
    ...
    public void setGradientColors(@ColorInt int i3, @ColorInt int i4, @ColorInt int i5, @ColorInt int i6) {
        this.topOuterStrokeColor = i3;
        this.topInnerStrokeColor = i4;
        this.bottomOuterStrokeColor = i5;
        this.bottomInnerStrokeColor = i6;
    }
