...
public class MaterialDialogs {
    ...
    @NonNull
    public static Rect getDialogBackgroundInsets(@NonNull Context context, @AttrRes int i3, int i4) {
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, (AttributeSet) null, R.styleable.MaterialAlertDialog, i3, i4, new int[0]);
