...
public class TooltipDrawable extends MaterialShapeDrawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private TooltipDrawable(@NonNull Context context2, AttributeSet attributeSet, @AttrRes int i3, @StyleRes int i4) {
        super(context2, attributeSet, i3, i4);
    ...
    @NonNull
    public static TooltipDrawable createFromAttributes(@NonNull Context context2, @Nullable AttributeSet attributeSet, @AttrRes int i3, @StyleRes int i4) {
        TooltipDrawable tooltipDrawable = new TooltipDrawable(context2, attributeSet, i3, i4);
    ...
    private void loadFromAttributes(@Nullable AttributeSet attributeSet, @AttrRes int i3, @StyleRes int i4) {
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(this.context, attributeSet, R.styleable.Tooltip, i3, i4, new int[0]);
        ...
        if (textAppearance != null) {
            ...
            if (obtainStyledAttributes.hasValue(i5)) {
                textAppearance.setTextColor(MaterialResources.getColorStateList(this.context, obtainStyledAttributes, i5));
            }
        }
        setTextAppearance(textAppearance);
        Class<TooltipDrawable> cls = TooltipDrawable.class;
        setFillColor(ColorStateList.valueOf(obtainStyledAttributes.getColor(R.styleable.Tooltip_backgroundTint, MaterialColors.layer(ColorUtils.setAlphaComponent(MaterialColors.getColor(this.context, 16842801, cls.getCanonicalName()), JNINativeInterface.NewDirectByteBuffer), ColorUtils.setAlphaComponent(MaterialColors.getColor(this.context, R.attr.colorOnBackground, cls.getCanonicalName()), 153)))));
    ...
    public void setLayoutMargin(@Px int i3) {
        this.layoutMargin = i3;
        invalidateSelf();
    }

    public void setMinHeight(@Px int i3) {
        this.minHeight = i3;
        invalidateSelf();
    }
    ...
    public void setTextPadding(@Px int i3) {
        this.padding = i3;
        invalidateSelf();
    }
