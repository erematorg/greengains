...
public class RippleUtils {
    ...
    public static class RippleUtilsLollipop {
        ...
        @DoNotInline
        public static Drawable createOvalRipple(@NonNull Context context, @Px int i3) {
            GradientDrawable gradientDrawable = new GradientDrawable();
            gradientDrawable.setColor(-1);
            gradientDrawable.setShape(1);
            return new RippleDrawable(MaterialColors.getColorStateList(context, R.attr.colorControlHighlight, ColorStateList.valueOf(0)), (Drawable) null, new InsetDrawable(gradientDrawable, i3, i3, i3, i3));
        }
    }
    ...
    @RequiresApi(21)
    @NonNull
    public static Drawable createOvalRippleLollipop(@NonNull Context context, @Px int i3) {
