...
abstract class HeaderBehavior<V extends View> extends ViewOffsetBehavior<V> {
    ...
    public final boolean fling(CoordinatorLayout coordinatorLayout, @NonNull V v2, int i3, int i4, float f2) {
        V v3 = v2;
        ...
        this.scroller.fling(0, getTopAndBottomOffset(), 0, Math.round(f2), 0, 0, i3, i4);
        if (this.scroller.computeScrollOffset()) {
            CoordinatorLayout coordinatorLayout2 = coordinatorLayout;
            FlingRunnable flingRunnable2 = new FlingRunnable(coordinatorLayout, v2);
            this.flingRunnable = flingRunnable2;
            ViewCompat.postOnAnimation(v2, flingRunnable2);
            return true;
        }
    ...
    public final int scroll(CoordinatorLayout coordinatorLayout, V v2, int i3, int i4, int i5) {
        return setHeaderTopBottomOffset(coordinatorLayout, v2, getTopBottomOffsetForScrollingSibling() - i3, i4, i5);
    }

    public int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, V v2, int i3) {
        return setHeaderTopBottomOffset(coordinatorLayout, v2, i3, Integer.MIN_VALUE, Integer.MAX_VALUE);
    }

    public int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, V v2, int i3, int i4, int i5) {
        int clamp;
