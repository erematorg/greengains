...
class ViewUtilsLollipop {
    ...
    public static void setDefaultAppBarLayoutStateListAnimator(@NonNull View view, float f2) {
        ...
        stateListAnimator.addState(new int[]{16842910, R.attr.state_liftable, -R.attr.state_lifted}, ObjectAnimator.ofFloat(view, "elevation", new float[]{0.0f}).setDuration(j2));
    ...
    public static void setStateListAnimatorFromAttrs(@NonNull View view, AttributeSet attributeSet, int i3, int i4) {
