...
abstract class HeaderScrollingViewBehavior extends ViewOffsetBehavior<View> {
    ...
    public final int getOverlapPixelsForOffset(View view) {
        ...
        return MathUtils.clamp((int) (overlapRatioForOffset * ((float) i3)), 0, i3);
    }
    ...
    public boolean onMeasureChild(@NonNull CoordinatorLayout coordinatorLayout, @NonNull View view, int i3, int i4, int i5, int i6) {
        ...
        coordinatorLayout.onMeasureChild(view, i3, i4, View.MeasureSpec.makeMeasureSpec(scrollRange, i7 == -1 ? 1073741824 : Integer.MIN_VALUE), i6);
        return true;
    }
