...
public class MaterialSwitch extends SwitchCompat {
    ...
    private void refreshThumbDrawable() {
        ...
        int i3 = this.thumbIconSize;
        super.setThumbDrawable(DrawableUtils.compositeTwoLayeredDrawable(drawable, drawable2, i3, i3));
    ...
    public void setThumbIconSize(@Px int i3) {
        if (this.thumbIconSize != i3) {
            this.thumbIconSize = i3;
            refreshThumbDrawable();
        }
    }
