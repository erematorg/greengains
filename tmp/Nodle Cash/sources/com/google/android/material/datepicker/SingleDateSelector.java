...
public class SingleDateSelector implements DateSelector<Long> {
    ...
    public String getSelectionContentDescription(@NonNull Context context) {
        ...
        Long l2 = this.selectedItem;
        return resources.getString(R.string.mtrl_picker_announce_current_selection, new Object[]{l2 == null ? resources.getString(R.string.mtrl_picker_announce_current_selection_none) : DateStrings.getYearMonthDay(l2.longValue())});
    }
    ...
    public String getSelectionDisplayString(@NonNull Context context) {
        ...
        return resources.getString(R.string.mtrl_picker_date_header_selected, new Object[]{DateStrings.getYearMonthDay(l2.longValue())});
    }
