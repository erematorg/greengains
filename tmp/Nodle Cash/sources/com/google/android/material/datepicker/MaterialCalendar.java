...
public final class MaterialCalendar<S> extends PickerFragment<S> {
    ...
    private void addActionsToMonthNavigation(@NonNull View view, @NonNull final MonthsPagerAdapter monthsPagerAdapter) {
        ...
        this.recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int i3, int i4) {
                int findFirstVisibleItemPosition = i3 < 0 ? MaterialCalendar.this.getLayoutManager().findFirstVisibleItemPosition() : MaterialCalendar.this.getLayoutManager().findLastVisibleItemPosition();
                        ...
                        if (!(f2 == null || next.second == null)) {
                            ...
                            for (int i5 = spanCount; i5 <= spanCount2; i5++) {
                                ...
                                if (findViewByPosition3 != null) {
                                    ...
                                    if (i5 != spanCount || findViewByPosition == null) {
                                        i3 = 0;
                                    } else {
                                        i3 = (findViewByPosition.getWidth() / 2) + findViewByPosition.getLeft();
                                    }
                                    if (i5 != spanCount2 || findViewByPosition2 == null) {
                                        i4 = recyclerView.getWidth();
                                    } else {
                                        i4 = (findViewByPosition2.getWidth() / 2) + findViewByPosition2.getLeft();
                                    }
                                    canvas.drawRect((float) i3, (float) top, (float) i4, (float) bottom, MaterialCalendar.this.calendarStyle.rangeFill);
                                }
                            }
                        }
                    }
    ...
    private static int getDialogPickerHeight(@NonNull Context context) {
        ...
        return a.D(dimensionPixelOffset, dimensionPixelSize, (resources.getDimensionPixelOffset(R.dimen.mtrl_calendar_month_vertical_padding) * (i3 - 1)) + (resources.getDimensionPixelSize(R.dimen.mtrl_calendar_day_height) * i3), resources.getDimensionPixelOffset(R.dimen.mtrl_calendar_bottom_padding));
    }

    @NonNull
    public static <T> MaterialCalendar<T> newInstance(@NonNull DateSelector<T> dateSelector2, @StyleRes int i3, @NonNull CalendarConstraints calendarConstraints2) {
        return newInstance(dateSelector2, i3, calendarConstraints2, (DayViewDecorator) null);
    }
    ...
    public View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        this.recyclerView.setLayoutManager(new SmoothCalendarLayoutManager(getContext(), i3, false) {
    ...
    @NonNull
    public static <T> MaterialCalendar<T> newInstance(@NonNull DateSelector<T> dateSelector2, @StyleRes int i3, @NonNull CalendarConstraints calendarConstraints2, @Nullable DayViewDecorator dayViewDecorator2) {
