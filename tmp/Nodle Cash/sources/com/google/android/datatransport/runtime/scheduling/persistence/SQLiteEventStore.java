...
public class SQLiteEventStore implements EventStore, SynchronizationGuard, ClientHealthMetricsStore {
    ...
    private LogEventDropped.Reason convertToReason(int i3) {
        ...
        Logging.d(LOG_TAG, "%n is not valid. No matched LogEventDropped-Reason found. Treated it as REASON_UNKNOWN", (Object) Integer.valueOf(i3));
        return reason;
    }

    private void ensureBeginTransaction(SQLiteDatabase sQLiteDatabase) {
        retryIfDbLocked(new f(sQLiteDatabase, 1), new b(6));
    }
    ...
    private TimeWindow getTimeWindow() {
        return (TimeWindow) inTransaction(new h(this.wallClock.getTime(), 0));
    }
    ...
    private Long getTransportContextId(SQLiteDatabase sQLiteDatabase, TransportContext transportContext) {
        ...
        return (Long) tryWithCursor(sQLiteDatabase.query("transport_contexts", new String[]{"_id"}, sb.toString(), (String[]) arrayList.toArray(new String[0]), (String) null, (String) null, (String) null), new b(0));
    }
    ...
    public /* synthetic */ Object lambda$cleanUp$11(Cursor cursor) {
        while (cursor.moveToNext()) {
            ...
            recordLogEventDropped((long) i3, LogEventDropped.Reason.MESSAGE_TOO_OLD, cursor.getString(1));
        }
        return null;
    }
    ...
    public /* synthetic */ Integer lambda$cleanUp$12(long j2, SQLiteDatabase sQLiteDatabase) {
        ...
        tryWithCursor(sQLiteDatabase.rawQuery("SELECT COUNT(*), transport_name FROM events WHERE timestamp_ms < ? GROUP BY transport_name", strArr), new e(this, 1));
    ...
    public static /* synthetic */ TimeWindow lambda$getTimeWindow$22(long j2, SQLiteDatabase sQLiteDatabase) {
        return (TimeWindow) tryWithCursor(sQLiteDatabase.rawQuery("SELECT last_metrics_upload_ms FROM global_log_event_state LIMIT 1", new String[0]), new h(j2, 1));
    }
    ...
    public /* synthetic */ Boolean lambda$hasPendingEventsFor$6(TransportContext transportContext, SQLiteDatabase sQLiteDatabase) {
        Long transportContextId = getTransportContextId(sQLiteDatabase, transportContext);
        return transportContextId == null ? Boolean.FALSE : (Boolean) tryWithCursor(getDb().rawQuery("SELECT 1 FROM events WHERE context_id = ? LIMIT 1", new String[]{transportContextId.toString()}), new b(7));
    }

    /* access modifiers changed from: private */
    public static /* synthetic */ List lambda$loadActiveContexts$10(SQLiteDatabase sQLiteDatabase) {
        return (List) tryWithCursor(sQLiteDatabase.rawQuery("SELECT distinct t._id, t.backend_name, t.priority, t.extras FROM transport_contexts AS t, events AS e WHERE e.context_id = t._id", new String[0]), new b(2));
    }
    ...
    public /* synthetic */ ClientMetrics lambda$loadClientMetrics$20(String str, Map map, ClientMetrics.Builder builder, SQLiteDatabase sQLiteDatabase) {
        return (ClientMetrics) tryWithCursor(sQLiteDatabase.rawQuery(str, new String[0]), new a(this, map, builder, 3));
    }
    ...
    public /* synthetic */ Object lambda$recordFailure$3(Cursor cursor) {
        while (cursor.moveToNext()) {
            int i3 = cursor.getInt(0);
            recordLogEventDropped((long) i3, LogEventDropped.Reason.MAX_RETRIES_REACHED, cursor.getString(1));
        }
        return null;
    }
    ...
    public /* synthetic */ Object lambda$recordFailure$4(String str, String str2, SQLiteDatabase sQLiteDatabase) {
        ...
        tryWithCursor(sQLiteDatabase.rawQuery(str2, (String[]) null), new e(this, 2));
    ...
    public static /* synthetic */ Object lambda$recordLogEventDropped$18(String str, LogEventDropped.Reason reason, long j2, SQLiteDatabase sQLiteDatabase) {
        if (!((Boolean) tryWithCursor(sQLiteDatabase.rawQuery("SELECT 1 FROM log_event_dropped WHERE log_source = ? AND reason = ?", new String[]{str, Integer.toString(reason.getNumber())}), new b(1))).booleanValue()) {
            ContentValues contentValues = new ContentValues();
            ...
            sQLiteDatabase.execSQL(a.j("UPDATE log_event_dropped SET events_dropped_count = events_dropped_count + ", j2, " WHERE log_source = ? AND reason = ?"), new String[]{str, Integer.toString(reason.getNumber())});
        }
        return null;
    }
    ...
    private List<PersistedEvent> loadEvents(SQLiteDatabase sQLiteDatabase, TransportContext transportContext, int i3) {
        ArrayList arrayList = new ArrayList();
        Long transportContextId = getTransportContextId(sQLiteDatabase, transportContext);
        if (transportContextId == null) {
            return arrayList;
        }
        tryWithCursor(sQLiteDatabase.query("events", new String[]{"_id", "transport_name", "timestamp_ms", "uptime_ms", "payload_encoding", "payload", "code", "inline", "product_id", "pseudonymous_id", "experiment_ids_clear_blob", "experiment_ids_encrypted_blob"}, "context_id = ?", new String[]{transportContextId.toString()}, (String) null, (String) null, (String) null, String.valueOf(i3)), new a(this, arrayList, transportContext, 1));
        return arrayList;
    }
    ...
    private Map<Long, Set<Metadata>> loadMetadata(SQLiteDatabase sQLiteDatabase, List<PersistedEvent> list) {
        ...
        sb.append(')');
        tryWithCursor(sQLiteDatabase.query("event_metadata", new String[]{"event_id", "name", "value"}, sb.toString(), (String[]) null, (String) null, (String) null, (String) null), new f(hashMap, 0));
        return hashMap;
    }
    ...
    private byte[] readPayload(long j2) {
        return (byte[]) tryWithCursor(getDb().query("event_payloads", new String[]{"bytes"}, "event_id = ?", new String[]{String.valueOf(j2)}, (String) null, (String) null, "sequence_num"), new b(3));
    }
    ...
    public int cleanUp() {
        return ((Integer) inTransaction(new d(this, this.wallClock.getTime() - this.config.getEventCleanUpAge()))).intValue();
    }

    @RestrictTo({RestrictTo.Scope.TESTS})
    public void clearDb() {
        inTransaction(new b(8));
    }
    ...
    public SQLiteDatabase getDb() {
        ...
        return (SQLiteDatabase) retryIfDbLocked(new f(schemaManager2, 2), new b(9));
    }

    public long getNextCallTime(TransportContext transportContext) {
        return ((Long) tryWithCursor(getDb().rawQuery("SELECT next_request_ms FROM transport_contexts WHERE backend_name = ? and priority = ?", new String[]{transportContext.getBackendName(), String.valueOf(PriorityMapping.toInt(transportContext.getPriority()))}), new b(5))).longValue();
    }

    public boolean hasPendingEventsFor(TransportContext transportContext) {
        return ((Boolean) inTransaction(new c(this, transportContext, 0))).booleanValue();
    }
    ...
    public Iterable<TransportContext> loadActiveContexts() {
        return (Iterable) inTransaction(new b(4));
    }

    public Iterable<PersistedEvent> loadBatch(TransportContext transportContext) {
        return (Iterable) inTransaction(new c(this, transportContext, 1));
    }

    public ClientMetrics loadClientMetrics() {
        return (ClientMetrics) inTransaction(new a(this, new HashMap(), ClientMetrics.newBuilder(), 0));
    }
    ...
    public PersistedEvent persist(TransportContext transportContext, EventInternal eventInternal) {
        ...
        long longValue = ((Long) inTransaction(new a(this, eventInternal, transportContext, 2))).longValue();
        if (longValue < 1) {
            return null;
        }
    ...
    public void recordFailure(Iterable<PersistedEvent> iterable) {
        if (iterable.iterator().hasNext()) {
            inTransaction(new c(this, "UPDATE events SET num_attempts = num_attempts + 1 WHERE _id in " + toIdList(iterable), 2));
        }
    }

    public void recordLogEventDropped(long j2, LogEventDropped.Reason reason, String str) {
        inTransaction(new g(j2, reason, str));
    }

    public void recordNextCallTime(TransportContext transportContext, long j2) {
        inTransaction(new d(transportContext, j2));
    }
