...
final class SchemaManager extends SQLiteOpenHelper {
    ...
    static {
        ...
        MIGRATE_TO_V4 = iVar4;
        i iVar5 = new i(4);
        MIGRATION_TO_V5 = iVar5;
        i iVar6 = new i(5);
        MIGRATE_TO_V6 = iVar6;
        i iVar7 = new i(6);
        MIGRATE_TO_V7 = iVar7;
        INCREMENTAL_MIGRATIONS = Arrays.asList(new Migration[]{iVar, iVar2, iVar3, iVar4, iVar5, iVar6, iVar7});
    }

    @Inject
    public SchemaManager(Context context, @Named("SQLITE_DB_NAME") String str, @Named("SCHEMA_VERSION") int i3) {
    ...
    private void upgrade(SQLiteDatabase sQLiteDatabase, int i3, int i4) {
        ...
        StringBuilder k2 = C0118y.k(i3, i4, "Migration from ", " to ", " was requested, but cannot be performed. Only ");
        k2.append(list.size());
