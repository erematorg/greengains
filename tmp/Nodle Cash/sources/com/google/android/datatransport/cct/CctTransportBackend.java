...
final class CctTransportBackend implements TransportBackend {
    ...
    public static final class HttpResponse {
        ...
        public HttpResponse(int i3, @Nullable URL url, long j2) {
            this.code = i3;
    ...
    public CctTransportBackend(Context context, Clock clock, Clock clock2, int i3) {
    ...
    public HttpResponse doSend(HttpRequest httpRequest) throws IOException {
        ...
        try {
            ...
            return new HttpResponse(Constants.MINIMAL_ERROR_STATUS_CODE, (URL) null, 0);
        } catch (Throwable th2) {
    ...
    private static URL parseUrlOrThrow(String str) {
        try {
            ...
            throw new IllegalArgumentException(c.a("Invalid url: ", str), e3);
        }
    }
    ...
    /* JADX WARNING: type inference failed for: r4v3, types: [com.google.android.datatransport.runtime.retries.RetryStrategy, java.lang.Object] */
    public BackendResponse send(BackendRequest backendRequest) {
        ...
        try {
            HttpResponse httpResponse = (HttpResponse) Retries.retry(5, new HttpRequest(url, requestBody, str), new a(this), new Object());
