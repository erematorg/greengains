...
public final class EnumValue extends GeneratedMessageLite<EnumValue, Builder> implements EnumValueOrBuilder {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.shaded.protobuf.EnumValue.AnonymousClass1.<clinit>():void");
        }
    }
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<EnumValue, Builder> implements EnumValueOrBuilder {
        ...
        public Builder setOptions(int i3, Option.Builder builder) {
            copyOnWrite();
            ((EnumValue) this.instance).setOptions(i3, (Option) builder.build());
            return this;
        }
        ...
        public Builder addOptions(int i3, Option.Builder builder) {
            copyOnWrite();
            ((EnumValue) this.instance).addOptions(i3, (Option) builder.build());
            return this;
        }
    }
