...
public class LazyFieldLite {
    ...
    public boolean containsDefaultInstance() {
        /*
            ...
            com.google.crypto.tink.shaded.protobuf.ByteString r2 = r2.delayedBytes
        ...
        L_0x0014:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.shaded.protobuf.LazyFieldLite.containsDefaultInstance():boolean");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void ensureInitialized(com.google.crypto.tink.shaded.protobuf.MessageLite r4) {
        /*
            r3 = this;
        ...
        L_0x0005:
            monitor-enter(r3)
            com.google.crypto.tink.shaded.protobuf.MessageLite r0 = r3.value     // Catch:{ all -> 0x000c }
        ...
        L_0x000c:
            ...
            goto L_0x0036
        L_0x000e:
            com.google.crypto.tink.shaded.protobuf.ByteString r0 = r3.delayedBytes     // Catch:{ InvalidProtocolBufferException -> 0x002e }
            if (r0 == 0) goto L_0x0027
            com.google.crypto.tink.shaded.protobuf.Parser r0 = r4.getParserForType()     // Catch:{ InvalidProtocolBufferException -> 0x002e }
            com.google.crypto.tink.shaded.protobuf.ByteString r1 = r3.delayedBytes     // Catch:{ InvalidProtocolBufferException -> 0x002e }
            com.google.crypto.tink.shaded.protobuf.ExtensionRegistryLite r2 = r3.extensionRegistry     // Catch:{ InvalidProtocolBufferException -> 0x002e }
            java.lang.Object r0 = r0.parseFrom((com.google.crypto.tink.shaded.protobuf.ByteString) r1, (com.google.crypto.tink.shaded.protobuf.ExtensionRegistryLite) r2)     // Catch:{ InvalidProtocolBufferException -> 0x002e }
            com.google.crypto.tink.shaded.protobuf.MessageLite r0 = (com.google.crypto.tink.shaded.protobuf.MessageLite) r0     // Catch:{ InvalidProtocolBufferException -> 0x002e }
            r3.value = r0     // Catch:{ InvalidProtocolBufferException -> 0x002e }
            com.google.crypto.tink.shaded.protobuf.ByteString r0 = r3.delayedBytes     // Catch:{ InvalidProtocolBufferException -> 0x002e }
            r3.memoizedBytes = r0     // Catch:{ InvalidProtocolBufferException -> 0x002e }
            goto L_0x0034
        L_0x0027:
            r3.value = r4     // Catch:{ InvalidProtocolBufferException -> 0x002e }
            com.google.crypto.tink.shaded.protobuf.ByteString r0 = com.google.crypto.tink.shaded.protobuf.ByteString.EMPTY     // Catch:{ InvalidProtocolBufferException -> 0x002e }
            r3.memoizedBytes = r0     // Catch:{ InvalidProtocolBufferException -> 0x002e }
            goto L_0x0034
        L_0x002e:
            r3.value = r4     // Catch:{ all -> 0x000c }
            com.google.crypto.tink.shaded.protobuf.ByteString r4 = com.google.crypto.tink.shaded.protobuf.ByteString.EMPTY     // Catch:{ all -> 0x000c }
            r3.memoizedBytes = r4     // Catch:{ all -> 0x000c }
        L_0x0034:
            monitor-exit(r3)     // Catch:{ all -> 0x000c }
            return
        L_0x0036:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.shaded.protobuf.LazyFieldLite.ensureInitialized(com.google.crypto.tink.shaded.protobuf.MessageLite):void");
    }
