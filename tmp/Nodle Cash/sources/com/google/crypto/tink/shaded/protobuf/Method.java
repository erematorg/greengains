...
public final class Method extends GeneratedMessageLite<Method, Builder> implements MethodOrBuilder {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.shaded.protobuf.Method.AnonymousClass1.<clinit>():void");
        }
    }
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Method, Builder> implements MethodOrBuilder {
        ...
        public Builder setOptions(int i3, Option.Builder builder) {
            copyOnWrite();
            ((Method) this.instance).setOptions(i3, (Option) builder.build());
            return this;
        }
        ...
        public Builder addOptions(int i3, Option.Builder builder) {
            copyOnWrite();
            ((Method) this.instance).addOptions(i3, (Option) builder.build());
            return this;
        }
    }
