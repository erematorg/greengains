...
public final class Type extends GeneratedMessageLite<Type, Builder> implements TypeOrBuilder {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.shaded.protobuf.Type.AnonymousClass1.<clinit>():void");
        }
    }
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Type, Builder> implements TypeOrBuilder {
        ...
        public Builder setFields(int i3, Field.Builder builder) {
            copyOnWrite();
            ((Type) this.instance).setFields(i3, (Field) builder.build());
            return this;
        }

        public Builder setOptions(int i3, Option.Builder builder) {
            copyOnWrite();
            ((Type) this.instance).setOptions(i3, (Option) builder.build());
            return this;
        }
        ...
        public Builder addFields(int i3, Field.Builder builder) {
            copyOnWrite();
            ((Type) this.instance).addFields(i3, (Field) builder.build());
            return this;
        }

        public Builder addOptions(int i3, Option.Builder builder) {
            copyOnWrite();
            ((Type) this.instance).addOptions(i3, (Option) builder.build());
            return this;
        }
    }
