...
final class AesCmacProtoSerialization {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.mac.AesCmacProtoSerialization.AnonymousClass1.<clinit>():void");
        }
    }
    ...
    static {
        ...
        PARAMETERS_SERIALIZER = ParametersSerializer.create(new a(0), AesCmacParameters.class, cls);
        ...
        KEY_SERIALIZER = KeySerializer.create(new a(2), AesCmacKey.class, cls2);
        KEY_PARSER = KeyParser.create(new a(3), bytesFromPrintableAscii, cls2);
    }
