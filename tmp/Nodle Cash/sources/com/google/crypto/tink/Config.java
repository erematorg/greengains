...
public final class Config {
    ...
    public static KeyTypeEntry getTinkKeyTypeEntry(String str, String str2, String str3, int i3, boolean z2) {
        KeyTypeEntry.Builder primitiveName = KeyTypeEntry.newBuilder().setPrimitiveName(str2);
        return (KeyTypeEntry) primitiveName.setTypeUrl("type.googleapis.com/google.crypto.tink." + str3).setKeyManagerVersion(i3).setNewKeyAllowed(z2).setCatalogueName(str).build();
    }
