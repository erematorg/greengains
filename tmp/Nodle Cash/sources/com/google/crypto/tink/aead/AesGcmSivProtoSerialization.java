...
final class AesGcmSivProtoSerialization {
    ...
    static {
        ...
        PARAMETERS_SERIALIZER = ParametersSerializer.create(new a(8), AesGcmSivParameters.class, cls);
        PARAMETERS_PARSER = ParametersParser.create(new a(9), bytesFromPrintableAscii, cls);
        Class<ProtoKeySerialization> cls2 = ProtoKeySerialization.class;
        KEY_SERIALIZER = KeySerializer.create(new a(10), AesGcmSivKey.class, cls2);
        KEY_PARSER = KeyParser.create(new a(11), bytesFromPrintableAscii, cls2);
    }
