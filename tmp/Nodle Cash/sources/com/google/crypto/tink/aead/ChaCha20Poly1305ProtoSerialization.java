...
final class ChaCha20Poly1305ProtoSerialization {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.aead.ChaCha20Poly1305ProtoSerialization.AnonymousClass1.<clinit>():void");
        }
    }
    ...
    static {
        ...
        PARAMETERS_SERIALIZER = ParametersSerializer.create(new a(12), ChaCha20Poly1305Parameters.class, cls);
        PARAMETERS_PARSER = ParametersParser.create(new a(13), bytesFromPrintableAscii, cls);
        Class<ProtoKeySerialization> cls2 = ProtoKeySerialization.class;
        KEY_SERIALIZER = KeySerializer.create(new a(14), ChaCha20Poly1305Key.class, cls2);
        KEY_PARSER = KeyParser.create(new a(15), bytesFromPrintableAscii, cls2);
    }
    ...
    public static ChaCha20Poly1305Key parseKey(ProtoKeySerialization protoKeySerialization, @Nullable SecretKeyAccess secretKeyAccess) throws GeneralSecurityException {
        if (protoKeySerialization.getTypeUrl().equals(TYPE_URL)) {
            try {
                ChaCha20Poly1305Key parseFrom = ChaCha20Poly1305Key.parseFrom(protoKeySerialization.getValue(), ExtensionRegistryLite.getEmptyRegistry());
