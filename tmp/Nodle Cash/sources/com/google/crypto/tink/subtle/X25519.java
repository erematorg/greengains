...
public final class X25519 {
    ...
    public static byte[] computeSharedSecret(byte[] bArr, byte[] bArr2) throws InvalidKeyException {
        if (bArr.length == 32) {
            ...
            byte b3 = (byte) (copyOf[31] & Byte.MAX_VALUE);
            copyOf[31] = b3;
            copyOf[31] = (byte) (b3 | SignedBytes.MAX_POWER_OF_TWO);
    ...
    public static byte[] generatePrivateKey() {
        ...
        byte b3 = (byte) (randBytes[31] & Utf8.REPLACEMENT_BYTE);
        randBytes[31] = b3;
        randBytes[31] = (byte) (b3 | 128);
        return randBytes;
    }
