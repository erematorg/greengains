...
public class KmlLayer extends Layer {
    public KmlLayer(GoogleMap googleMap, int i3, Context context) throws XmlPullParserException, IOException {
    ...
    public KmlLayer(GoogleMap googleMap, @RawRes int i3, Context context, MarkerManager markerManager, PolygonManager polygonManager, PolylineManager polylineManager, GroundOverlayManager groundOverlayManager, Renderer.ImagesCache imagesCache) throws XmlPullParserException, IOException {
