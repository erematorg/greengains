...
public class GeoJsonLayer extends Layer {
    ...
    public GeoJsonLayer(GoogleMap googleMap, int i3, Context context, MarkerManager markerManager, PolygonManager polygonManager, PolylineManager polylineManager, GroundOverlayManager groundOverlayManager) throws IOException, JSONException {
    ...
    public GeoJsonLayer(GoogleMap googleMap, int i3, Context context) throws IOException, JSONException {
        this(googleMap, createJsonFileObject(context.getResources().openRawResource(i3)), (MarkerManager) null, (PolygonManager) null, (PolylineManager) null, (GroundOverlayManager) null);
    }
}
