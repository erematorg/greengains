...
public final class ObjectTypeAdapter extends TypeAdapter<Object> {
    ...
    public static TypeAdapterFactory getFactory(ToNumberStrategy toNumberStrategy2) {
        return toNumberStrategy2 == ToNumberPolicy.DOUBLE ? DOUBLE_FACTORY : newFactory(toNumberStrategy2);
    }
    ...
    private Object readTerminal(JsonReader jsonReader, JsonToken jsonToken) throws IOException {
        int i3 = AnonymousClass2.$SwitchMap$com$google$gson$stream$JsonToken[jsonToken.ordinal()];
        if (i3 == 3) {
