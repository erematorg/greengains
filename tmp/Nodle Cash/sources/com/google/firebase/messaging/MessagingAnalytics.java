    ...
    public static long getProjectNumber(Bundle bundle) {
        if (bundle.containsKey(Constants.MessagePayloadKeys.SENDER_ID)) {
            try {
                ...
                Log.w(Constants.TAG, "error parsing project number", e3);
            }
        }
        ...
        if (gcmSenderId != null) {
            try {
                ...
                Log.w(Constants.TAG, "error parsing sender ID", e4);
            }
        }
        ...
        try {
            ...
            if (messageTime != null) {
                try {
                    ...
                    Log.w(Constants.TAG, "Error while parsing timestamp in GCM event", e3);
                }
            }
            ...
            if (useDeviceTime != null) {
                try {
                    ...
                    Log.w(Constants.TAG, "Error while parsing use_device_time in GCM event", e4);
                }
            }
