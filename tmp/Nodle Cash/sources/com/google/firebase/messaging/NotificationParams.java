...
public class NotificationParams {
    ...
    public Integer getInteger(String str) {
        ...
        try {
            ...
            Log.w(TAG, a.r(new StringBuilder("Couldn't parse value of "), userFriendlyKey(str), "(", string, ") into an int"));
            return null;
        }
    }
    ...
    public JSONArray getJSONArray(String str) {
        ...
        try {
            ...
            Log.w(TAG, a.r(new StringBuilder("Malformed JSON for key "), userFriendlyKey(str), ": ", string, ", falling back to default"));
            return null;
        }
    }
    ...
    public int[] getLightSettings() {
        ...
        try {
            ...
            Log.w(TAG, "LightSettings is invalid: " + jSONArray + ". " + e3.getMessage() + ". Skipping setting LightSettings");
            return null;
        }
    }
    ...
    public String getLocalizedString(Resources resources, String str, String str2) {
        ...
        if (identifier == 0) {
            Log.w(TAG, a.r(new StringBuilder(), userFriendlyKey(a.m(str2, Constants.MessageNotificationKeys.TEXT_RESOURCE_SUFFIX)), " resource not found: ", str2, " Default value will be used."));
            return null;
        }
        ...
        try {
            ...
            Log.w(TAG, "Missing format argument for " + userFriendlyKey(str2) + ": " + Arrays.toString(localizationArgsForKey) + " Default value will be used.", e3);
            return null;
        }
    }
    ...
    public Long getLong(String str) {
        ...
        try {
            ...
            Log.w(TAG, a.r(new StringBuilder("Couldn't parse value of "), userFriendlyKey(str), "(", string, ") into a long"));
            return null;
        }
    }
