...
final class TopicOperation {
    ...
    private TopicOperation(String str, String str2) {
        ...
        this.operation = str;
        this.serializedString = a.n(str, OPERATION_PAIR_DIVIDER, str2);
    }
    ...
    private static String normalizeTopicOrThrow(String str, String str2) {
        if (str != null && str.startsWith(OLD_TOPIC_PREFIX)) {
            Log.w(Constants.TAG, "Format /topics/topic-name is deprecated. Only 'topic-name' should be used in " + str2 + JwtUtilsKt.JWT_DELIMITER);
            str = str.substring(8);
        }
        if (str != null && TOPIC_NAME_REGEXP.matcher(str).matches()) {
            return str;
        }
        throw new IllegalArgumentException(A.a.l("Invalid topic name: ", str, " does not match the allowed format [a-zA-Z0-9-_.~%]{1,900}."));
    }
