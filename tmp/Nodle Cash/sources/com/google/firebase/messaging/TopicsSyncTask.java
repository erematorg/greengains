...
class TopicsSyncTask implements Runnable {
    ...
    public TopicsSyncTask(TopicsSubscriber topicsSubscriber2, Context context2, Metadata metadata2, long j2) {
    ...
    private static String createPermissionMissingLog(String str) {
        return a.l("Missing Permission: ", str, ". This permission should normally be included by the manifest merger, but may needed to be manually added to your manifest");
    }
    ...
    private static boolean hasAccessNetworkStatePermission(Context context2) {
        ...
        synchronized (TOPIC_SYNC_TASK_LOCK) {
            try {
                ...
                Boolean valueOf = Boolean.valueOf(bool == null ? hasPermission(context2, "android.permission.ACCESS_NETWORK_STATE", bool) : bool.booleanValue());
    ...
    private static boolean hasPermission(Context context2, String str, Boolean bool) {
        ...
        boolean z2 = context2.checkCallingOrSelfPermission(str) == 0;
    ...
    private static boolean hasWakeLockPermission(Context context2) {
        ...
        synchronized (TOPIC_SYNC_TASK_LOCK) {
            try {
                ...
                Boolean valueOf = Boolean.valueOf(bool == null ? hasPermission(context2, "android.permission.WAKE_LOCK", bool) : bool.booleanValue());
