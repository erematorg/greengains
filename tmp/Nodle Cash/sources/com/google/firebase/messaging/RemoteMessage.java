...
public final class RemoteMessage extends AbstractSafeParcelable {
    ...
    public static class Builder {
        ...
        public Builder(@NonNull String str) {
            ...
            throw new IllegalArgumentException(c.a("Invalid to: ", str));
        }
        ...
        public int getTtl() {
            return Integer.parseInt(this.bundle.getString(Constants.MessagePayloadKeys.MESSAGE_TYPE, SchemaSymbols.ATTVAL_FALSE_0));
        }
        ...
        public Builder setTtl(@IntRange(from = 0, to = 86400) int i3) {
            this.bundle.putString(Constants.MessagePayloadKeys.TTL, String.valueOf(i3));
            return this;
        }
    }
    ...
    public void writeToParcel(@NonNull Parcel parcel, int i3) {
        RemoteMessageCreator.writeToParcel(this, parcel, i3);
    }
}
