...
public interface ExecutorFactory {
    ...
    ScheduledExecutorService newScheduledThreadPool(int i3, ThreadPriority threadPriority);

    ScheduledExecutorService newScheduledThreadPool(int i3, ThreadFactory threadFactory, ThreadPriority threadPriority);
    ...
    ExecutorService newThreadPool(int i3, ThreadPriority threadPriority);

    ExecutorService newThreadPool(int i3, ThreadFactory threadFactory, ThreadPriority threadPriority);
