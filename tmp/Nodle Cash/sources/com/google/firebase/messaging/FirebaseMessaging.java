...
public class FirebaseMessaging {
    ...
    @VisibleForTesting
    static Provider<TransportFactory> transportFactory = new g(5);
        ...
        public synchronized void initialize() {
            try {
                if (!this.initialized) {
                    ...
                    if (readEnabled == null) {
                        i iVar = new i(this);
                        this.dataCollectionDefaultChangeEventHandler = iVar;
                        this.subscriber.subscribe(DataCollectionDefaultChange.class, iVar);
                    }
    ...
    public FirebaseMessaging(FirebaseApp firebaseApp2, @Nullable FirebaseInstanceIdInternal firebaseInstanceIdInternal, Provider<UserAgentPublisher> provider, Provider<HeartBeatInfo> provider2, FirebaseInstallationsApi firebaseInstallationsApi, Provider<TransportFactory> provider3, Subscriber subscriber) {
    ...
    private void handleProxiedNotificationData() {
        this.gmsRpc.getProxyNotificationData().addOnSuccessListener(this.initExecutor, new g(this, 3));
    }
    ...
    public /* synthetic */ Task lambda$blockingGetToken$14(String str, Store.Token token) {
        return this.gmsRpc.getToken().onSuccessTask(this.fileExecutor, new h(this, str, token));
    }
    ...
    public String blockingGetToken() throws IOException {
        ...
        if (firebaseInstanceIdInternal != null) {
            ...
            try {
                return (String) Tasks.await(this.requestDeduplicator.getOrStartGetTokenRequest(defaultSenderId, new h(this, defaultSenderId, tokenWithoutTriggeringSync)));
    ...
    public Task<Void> deleteToken() {
        if (this.iid != null) {
            ...
            this.initExecutor.execute(new e(this, taskCompletionSource, 2));
            return taskCompletionSource.getTask();
        } else if (getTokenWithoutTriggeringSync() == null) {
            return Tasks.forResult(null);
        } else {
            TaskCompletionSource taskCompletionSource2 = new TaskCompletionSource();
            FcmExecutors.newNetworkIOExecutor().execute(new e(this, taskCompletionSource2, 0));
    ...
    public Task<String> getToken() {
        ...
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
        this.initExecutor.execute(new e(this, taskCompletionSource, 1));
        return taskCompletionSource.getTask();
    }
    ...
    public Task<Void> setNotificationDelegationEnabled(boolean z2) {
        return ProxyNotificationInitializer.setEnableProxyNotification(this.initExecutor, this.context, z2).addOnSuccessListener((Executor) new a(2), new g(this, 2));
    }
    ...
    public synchronized void syncWithDelaySecondsInternal(long j2) {
        enqueueTaskWithDelaySeconds(new SyncTask(this, Math.min(Math.max(30, 2 * j2), MAX_DELAY_SEC)), j2);
    ...
    public FirebaseMessaging(FirebaseApp firebaseApp2, @Nullable FirebaseInstanceIdInternal firebaseInstanceIdInternal, Provider<TransportFactory> provider, Subscriber subscriber, Metadata metadata2, GmsRpc gmsRpc2, Executor executor, Executor executor2, Executor executor3) {
        ...
        if (firebaseInstanceIdInternal != null) {
            firebaseInstanceIdInternal.addNewTokenListener(new g(this, 1));
        }
        executor2.execute(new f(this, 0));
        ...
        createInstance.addOnSuccessListener(executor2, (OnSuccessListener<? super TopicsSubscriber>) new g(this, 0));
        executor2.execute(new f(this, 1));
    }
}
