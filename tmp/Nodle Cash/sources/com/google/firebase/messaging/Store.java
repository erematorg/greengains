...
class Store {
    ...
    public static class Token {
        ...
        public static String encode(String str, String str2, long j2) {
            try {
                ...
                Log.w(Constants.TAG, "Failed to encode token: " + e3);
                return null;
            }
        }
        ...
        public static Token parse(String str) {
            ...
            try {
                ...
                Log.w(Constants.TAG, "Failed to parse token: " + e3);
                return null;
            }
        }
        ...
        if (!file.exists()) {
            try {
                ...
                if (Log.isLoggable(Constants.TAG, 3)) {
                    Log.d(Constants.TAG, "Error creating file in no backup dir: " + e3.getMessage());
                }
            }
        }
    }
    ...
    private String createTokenKey(String str, String str2) {
        return b.m(str, STORE_KEY_TOKEN, str2, "|*");
    }
