...
public class DefaultHeartBeatController implements HeartBeatController, HeartBeatInfo {
        ...
        synchronized (this) {
            try {
                ...
                for (int i3 = 0; i3 < allHeartBeats.size(); i3++) {
                    HeartBeatResult heartBeatResult = allHeartBeats.get(i3);
    ...
    public Task<String> getHeartBeatsHeader() {
        return !UserManagerCompat.isUserUnlocked(this.applicationContext) ? Tasks.forResult("") : Tasks.call(this.backgroundExecutor, new a(this, 0));
    }

    public Task<Void> registerHeartBeat() {
        return this.consumers.size() <= 0 ? Tasks.forResult(null) : !UserManagerCompat.isUserUnlocked(this.applicationContext) ? Tasks.forResult(null) : Tasks.call(this.backgroundExecutor, new a(this, 1));
    }
