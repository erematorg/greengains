...
class DefaultSettingsSpiCall implements SettingsSpiCall {
    ...
    private JSONObject getJsonObjectFrom(String str) {
        try {
            ...
            logger2.w("Failed to parse settings JSON from " + this.url, e3);
    ...
    public JSONObject handleResponse(HttpResponse httpResponse) {
        ...
        Logger logger3 = this.logger;
        StringBuilder o3 = a.o(code, "Settings request failed; (status: ", ") from ");
        o3.append(this.url);
        logger3.e(o3.toString());
        return null;
    }
    ...
    public JSONObject invoke(SettingsRequest settingsRequest, boolean z2) {
        if (z2) {
            try {
                ...
                this.logger.e("Settings request failed.", e3);
                return null;
            }
        } else {
    ...
    public boolean requestWasSuccessful(int i3) {
