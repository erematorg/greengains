...
public interface ObjectEncoderContext {
    ...
    @NonNull
    ObjectEncoderContext add(@NonNull FieldDescriptor fieldDescriptor, int i3) throws IOException;
    ...
    @NonNull
    @Deprecated
    ObjectEncoderContext add(@NonNull String str, int i3) throws IOException;
