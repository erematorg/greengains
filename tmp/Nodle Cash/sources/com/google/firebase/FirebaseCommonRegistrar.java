...
public class FirebaseCommonRegistrar implements ComponentRegistrar {
    ...
    public List<Component<?>> getComponents() {
        ...
        arrayList.add(LibraryVersionComponent.fromContext(TARGET_SDK, new a(26)));
        arrayList.add(LibraryVersionComponent.fromContext(MIN_SDK, new a(27)));
        arrayList.add(LibraryVersionComponent.fromContext(ANDROID_PLATFORM, new a(28)));
        arrayList.add(LibraryVersionComponent.fromContext(ANDROID_INSTALLER, new a(29)));
