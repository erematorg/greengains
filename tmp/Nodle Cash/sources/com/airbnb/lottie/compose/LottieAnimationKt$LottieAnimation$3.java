...
public final class LottieAnimationKt$LottieAnimation$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public LottieAnimationKt$LottieAnimation$3(LottieComposition lottieComposition, Function0<Float> function0, Modifier modifier, boolean z2, boolean z3, boolean z4, RenderMode renderMode, boolean z5, LottieDynamicProperties lottieDynamicProperties, Alignment alignment, ContentScale contentScale, boolean z6, Map<String, ? extends Typeface> map, AsyncUpdates asyncUpdates, int i3, int i4, int i5) {
        super(2);
