...
public class AnimatableValueParser {
    ...
    public static AnimatableFloatValue parseFloat(JsonReader jsonReader, LottieComposition lottieComposition, boolean z2) throws IOException {
        return new AnimatableFloatValue(parse(jsonReader, z2 ? Utils.dpScale() : 1.0f, lottieComposition, FloatParser.INSTANCE));
    }
}
