...
public class AnimatableTransformParser {
    ...
    private static boolean isPositionIdentity(AnimatableValue<PointF, PointF> animatableValue) {
        return animatableValue == null || (!(animatableValue instanceof AnimatableSplitDimensionPathValue) && animatableValue.isStatic() && ((PointF) animatableValue.getKeyframes().get(0).startValue).equals(0.0f, 0.0f));
    }
        ...
        while (jsonReader.hasNext()) {
            switch (jsonReader2.selectName(NAMES)) {
                ...
                case 5:
                    ...
                    continue;
                case 6:
                    animatableFloatValue4 = AnimatableValueParser.parseFloat(jsonReader2, lottieComposition2, z3);
                    continue;
                case 7:
                    animatableFloatValue5 = AnimatableValueParser.parseFloat(jsonReader2, lottieComposition2, z3);
                    continue;
                case 8:
                    animatableFloatValue2 = AnimatableValueParser.parseFloat(jsonReader2, lottieComposition2, z3);
                    continue;
                case 9:
                    animatableFloatValue3 = AnimatableValueParser.parseFloat(jsonReader2, lottieComposition2, z3);
                    continue;
                default:
                    jsonReader.skipName();
                    jsonReader.skipValue();
            ...
            AnimatableFloatValue parseFloat = AnimatableValueParser.parseFloat(jsonReader2, lottieComposition2, z3);
