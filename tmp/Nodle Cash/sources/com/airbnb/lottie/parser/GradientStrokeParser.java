...
class GradientStrokeParser {
    ...
    public static GradientStroke parse(JsonReader jsonReader, LottieComposition lottieComposition) throws IOException {
                    ...
                    while (jsonReader.hasNext()) {
                        ...
                        if (selectName != 0) {
                            ...
                            if (selectName != 1) {
                                ...
                                animatableGradientColorValue2 = AnimatableValueParser.parseGradientColor(jsonReader2, lottieComposition2, i3);
                            }
                        } else {
                            animatableGradientColorValue = animatableGradientColorValue2;
        ...
        return new GradientStroke(str8, gradientType, animatableGradientColorValue2, animatableIntegerValue, animatablePointValue, animatablePointValue2, animatableFloatValue, lineCapType, lineJoinType, f2, arrayList, animatableFloatValue2, z2);
    }
}
