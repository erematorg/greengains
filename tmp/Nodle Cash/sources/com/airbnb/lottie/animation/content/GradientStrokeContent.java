...
public class GradientStrokeContent extends BaseStrokeContent {
    ...
    private RadialGradient getRadialGradient() {
        ...
        float f2 = value.x;
        float f3 = value.y;
        RadialGradient radialGradient2 = new RadialGradient(f2, f3, (float) Math.hypot((double) (value2.x - f2), (double) (value2.y - f3)), applyDynamicColorsIfNeeded, positions, Shader.TileMode.CLAMP);
