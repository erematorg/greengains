...
public class IntegerKeyframeAnimation extends KeyframeAnimation<Integer> {
    ...
    public int getIntValue(Keyframe<Integer> keyframe, float f2) {
        ...
        if (lottieValueCallback != null) {
            Integer num = (Integer) lottieValueCallback.getValueInternal(keyframe.startFrame, keyframe.endFrame.floatValue(), (Integer) keyframe.startValue, (Integer) keyframe.endValue, f2, getLinearCurrentKeyframeProgress(), getProgress());
            if (num != null) {
                return num.intValue();
            }
        }
