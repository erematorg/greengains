...
public abstract class DataRenderer extends Renderer {
    ...
    public abstract void drawValue(Canvas canvas, String str, float f2, float f3, int i3);
    ...
    public boolean isDrawingValuesAllowed(ChartInterface chartInterface) {
        return ((float) chartInterface.getData().getEntryCount()) < this.mViewPortHandler.getScaleX() * ((float) chartInterface.getMaxVisibleCount());
    }
}
