    ...
    public void drawLabels(Canvas canvas, float f2, MPPointF mPPointF) {
        ...
        for (int i5 = 0; i5 < i3; i5 += 2) {
            ...
            if (this.mViewPortHandler.isInBoundsX(f4)) {
                ...
                int i6 = i5 / 2;
                String axisLabel = valueFormatter.getAxisLabel(xAxis.mEntries[i6], xAxis);
                if (this.mXAxis.isAvoidFirstLastClippingEnabled()) {
                    ...
                    if (i6 == i7 - 1 && i7 > 1) {
                        ...
                        f3 = (((float) Utils.calcTextWidth(this.mAxisLabelPaint, axisLabel)) / 2.0f) + f4;
    ...
    public void renderAxisLabels(Canvas canvas) {
        if (this.mXAxis.isEnabled() && this.mXAxis.isDrawLabelsEnabled()) {
            ...
            if (this.mXAxis.getPosition() == XAxis.XAxisPosition.TOP) {
                instance.f6574x = 0.5f;
                instance.f6575y = 1.0f;
    ...
    public void renderLimitLineLabel(Canvas canvas, LimitLine limitLine, float[] fArr, float f2) {
        ...
        if (label != null && !label.equals("")) {
            ...
            if (labelPosition == LimitLine.LimitLabelPosition.RIGHT_TOP) {
                ...
                canvas.drawText(label, fArr[0] + xOffset, this.mViewPortHandler.contentTop() + f2 + ((float) Utils.calcTextHeight(this.mLimitLinePaint, label)), this.mLimitLinePaint);
            } else if (labelPosition == LimitLine.LimitLabelPosition.RIGHT_BOTTOM) {
                this.mLimitLinePaint.setTextAlign(Paint.Align.LEFT);
                canvas.drawText(label, fArr[0] + xOffset, this.mViewPortHandler.contentBottom() - f2, this.mLimitLinePaint);
