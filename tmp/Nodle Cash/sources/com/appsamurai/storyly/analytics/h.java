...
public final class h extends Lambda implements Function1<JsonArrayBuilder, Unit> {
    ...
    public final /* synthetic */ StorylyConfig f3541a;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public h(StorylyConfig storylyConfig) {
        super(1);
        this.f3541a = storylyConfig;
    }
    ...
    public Object invoke(Object obj) {
        ...
        for (Number intValue : this.f3541a.getGroup$storyly_release().getIconBorderColorSeen$storyly_release()) {
