package com.appsamurai.storyly.exoplayer2.core.decoder;
...
public final class DecoderReuseEvaluation {
    ...
    public int hashCode() {
        int i3 = a.i(this.decoderName, (((527 + this.result) * 31) + this.discardReasons) * 31, 31);
        return this.newFormat.hashCode() + ((this.oldFormat.hashCode() + i3) * 31);
    }
}
