...
public final class DefaultBandwidthMeter implements BandwidthMeter, TransferListener {
    ...
    public static final ImmutableList<Long> DEFAULT_INITIAL_BITRATE_ESTIMATES_5G_NSA = ImmutableList.of(6000000L, 4100000L, 3200000L, Long.valueOf(Constants.SESSION_TIMEOUT_MILLIS), 1000000L);
    ...
    public static int[] getInitialBitrateCountryGroupAssignment(java.lang.String r8) {
        ...
        L_0x107c:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appsamurai.storyly.exoplayer2.core.upstream.DefaultBandwidthMeter.getInitialBitrateCountryGroupAssignment(java.lang.String):int[]");
    }

    private long getInitialBitrateEstimateForNetworkType(int i3) {
        Long l2 = this.initialBitrateEstimates.get(Integer.valueOf(i3));
        if (l2 == null) {
    ...
    private void maybeNotifyBandwidthSample(int i3, long j2, long j3) {
        if (i3 != 0 || j2 != 0 || j3 != this.lastReportedBitrateEstimate) {
            this.lastReportedBitrateEstimate = j3;
            this.eventDispatcher.bandwidthSample(i3, j2, j3);
        }
    }
    ...
    public synchronized void onNetworkTypeChanged(int r9) {
        /*
            r8 = this;
            monitor-enter(r8)
            int r0 = r8.networkType     // Catch:{ all -> 0x000b }
            if (r0 == 0) goto L_0x000d
            boolean r1 = r8.resetOnNetworkTypeChange     // Catch:{ all -> 0x000b }
        ...
        L_0x000b:
            ...
            goto L_0x0057
        L_0x000d:
            boolean r1 = r8.networkTypeOverrideSet     // Catch:{ all -> 0x000b }
            if (r1 == 0) goto L_0x0013
            int r9 = r8.networkTypeOverride     // Catch:{ all -> 0x000b }
        L_0x0013:
            if (r0 != r9) goto L_0x0017
            monitor-exit(r8)
            return
        L_0x0017:
            r8.networkType = r9     // Catch:{ all -> 0x000b }
            r0 = 1
            ...
            goto L_0x0055
        L_0x0023:
            long r0 = r8.getInitialBitrateEstimateForNetworkType(r9)     // Catch:{ all -> 0x000b }
            r8.bitrateEstimate = r0     // Catch:{ all -> 0x000b }
            com.appsamurai.storyly.exoplayer2.common.util.Clock r9 = r8.clock     // Catch:{ all -> 0x000b }
            long r0 = r9.elapsedRealtime()     // Catch:{ all -> 0x000b }
            int r9 = r8.streamCount     // Catch:{ all -> 0x000b }
            if (r9 <= 0) goto L_0x003a
            long r2 = r8.sampleStartTimeMs     // Catch:{ all -> 0x000b }
            long r2 = r0 - r2
        ...
        L_0x003a:
            ...
            goto L_0x0038
        L_0x003c:
            long r4 = r8.sampleBytesTransferred     // Catch:{ all -> 0x000b }
            long r6 = r8.bitrateEstimate     // Catch:{ all -> 0x000b }
            r2 = r8
            r2.maybeNotifyBandwidthSample(r3, r4, r6)     // Catch:{ all -> 0x000b }
            r8.sampleStartTimeMs = r0     // Catch:{ all -> 0x000b }
            r0 = 0
            r8.sampleBytesTransferred = r0     // Catch:{ all -> 0x000b }
            r8.totalBytesTransferred = r0     // Catch:{ all -> 0x000b }
            r8.totalElapsedTimeMs = r0     // Catch:{ all -> 0x000b }
            com.appsamurai.storyly.exoplayer2.core.upstream.SlidingPercentile r9 = r8.slidingPercentile     // Catch:{ all -> 0x000b }
            r9.reset()     // Catch:{ all -> 0x000b }
            monitor-exit(r8)
            return
        L_0x0055:
            monitor-exit(r8)
        ...
        L_0x0057:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appsamurai.storyly.exoplayer2.core.upstream.DefaultBandwidthMeter.onNetworkTypeChanged(int):void");
    }
    ...
    public synchronized void onBytesTransferred(DataSource dataSource, DataSpec dataSpec, boolean z2, int i3) {
        if (isTransferAtFullNetworkSpeed(dataSpec, z2)) {
            this.sampleBytesTransferred += (long) i3;
        }
    }
    ...
    public synchronized void setNetworkTypeOverride(int i3) {
        this.networkTypeOverride = i3;
        this.networkTypeOverrideSet = true;
        onNetworkTypeChanged(i3);
    }
    ...
    public static final class Builder {
        ...
        private static Map<Integer, Long> getInitialBitrateEstimatesForCountry(String str) {
            ...
            hashMap.put(3, DefaultBandwidthMeter.DEFAULT_INITIAL_BITRATE_ESTIMATES_2G.get(access$100[1]));
            hashMap.put(4, DefaultBandwidthMeter.DEFAULT_INITIAL_BITRATE_ESTIMATES_3G.get(access$100[2]));
            hashMap.put(5, DefaultBandwidthMeter.DEFAULT_INITIAL_BITRATE_ESTIMATES_4G.get(access$100[3]));
            hashMap.put(10, DefaultBandwidthMeter.DEFAULT_INITIAL_BITRATE_ESTIMATES_5G_NSA.get(access$100[4]));
            hashMap.put(9, DefaultBandwidthMeter.DEFAULT_INITIAL_BITRATE_ESTIMATES_5G_SA.get(access$100[5]));
        ...
        public Builder setInitialBitrateEstimate(long j2) {
            for (Integer intValue : this.initialBitrateEstimates.keySet()) {
                setInitialBitrateEstimate(intValue.intValue(), j2);
            }
            return this;
        }
        ...
        public Builder setSlidingWindowMaxWeight(int i3) {
            this.slidingWindowMaxWeight = i3;
            return this;
        }

        public Builder setInitialBitrateEstimate(int i3, long j2) {
            this.initialBitrateEstimates.put(Integer.valueOf(i3), Long.valueOf(j2));
            return this;
        }
    ...
    private DefaultBandwidthMeter(@Nullable Context context, Map<Integer, Long> map, int i3, Clock clock2, boolean z2) {
