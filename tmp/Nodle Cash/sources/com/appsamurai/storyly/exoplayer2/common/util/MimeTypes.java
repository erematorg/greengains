...
public final class MimeTypes {
    ...
    public static final class CustomMimeType {
        ...
        public CustomMimeType(String str, String str2, int i3) {
            this.mimeType = str;
    ...
    public static final class Mp4aObjectType {
        ...
        public Mp4aObjectType(int i3, int i4) {
            this.objectTypeIndication = i3;
            this.audioObjectTypeIndication = i4;
        }

        public int getEncoding() {
            int i3 = this.audioObjectTypeIndication;
            if (i3 == 2) {
                return 10;
            }
            if (i3 == 5) {
    ...
    @Nullable
    public static String getMimeTypeFromMp4ObjectType(int i3) {
        if (i3 == 32) {
            return VIDEO_MP4V;
        }
        if (i3 == 33) {
    ...
    public static void registerCustomMimeType(String str, String str2, int i3) {
        CustomMimeType customMimeType = new CustomMimeType(str, str2, i3);
        int size = customMimeTypes.size();
        int i4 = 0;
        while (true) {
            if (i4 >= size) {
