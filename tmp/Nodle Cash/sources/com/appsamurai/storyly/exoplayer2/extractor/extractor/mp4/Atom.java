...
abstract class Atom {
    ...
    public static final class ContainerAtom extends Atom {
        ...
        public ContainerAtom(int i3, long j2) {
            super(i3);
            this.endPosition = j2;
        }
        ...
        public int getChildAtomOfTypeCount(int i3) {
            int size = this.leafChildren.size();
            int i4 = 0;
            for (int i5 = 0; i5 < size; i5++) {
                if (this.leafChildren.get(i5).type == i3) {
                    i4++;
                }
            }
            int size2 = this.containerChildren.size();
            for (int i6 = 0; i6 < size2; i6++) {
                if (this.containerChildren.get(i6).type == i3) {
                    i4++;
                }
            }
            return i4;
        ...
        public ContainerAtom getContainerAtomOfType(int i3) {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                ContainerAtom containerAtom = this.containerChildren.get(i4);
                if (containerAtom.type == i3) {
        ...
        public LeafAtom getLeafAtomOfType(int i3) {
            int size = this.leafChildren.size();
            for (int i4 = 0; i4 < size; i4++) {
                LeafAtom leafAtom = this.leafChildren.get(i4);
                if (leafAtom.type == i3) {
                    return leafAtom;
                }
            }
