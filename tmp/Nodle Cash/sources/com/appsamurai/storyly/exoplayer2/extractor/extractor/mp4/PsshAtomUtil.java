...
public final class PsshAtomUtil {
    ...
    public static class PsshAtom {
        ...
        public PsshAtom(UUID uuid2, int i3, byte[] bArr) {
            this.uuid = uuid2;
            this.version = i3;
    ...
    private static PsshAtom parsePsshAtom(byte[] bArr) {
        ...
        if (parseFullAtomVersion > 1) {
            r.a(parseFullAtomVersion, "Unsupported pssh version: ", TAG);
            return null;
        }
    ...
    public static byte[] parseSchemeSpecificData(byte[] bArr, UUID uuid) {
        ...
        Log.w(TAG, "UUID mismatch. Expected: " + uuid + ", got: " + parsePsshAtom.uuid + JwtUtilsKt.JWT_DELIMITER);
        return null;
    }
    ...
    public static byte[] buildPsshAtom(UUID uuid, @Nullable UUID[] uuidArr, @Nullable byte[] bArr) {
        ...
        if (uuidArr != null) {
            length = b.a(uuidArr.length, 16, 4, length);
        }
