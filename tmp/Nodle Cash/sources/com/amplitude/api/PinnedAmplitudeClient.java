        ...
        public SSLContext build() {
            try {
                ...
                for (String decodeBase64 : this.certificateBase64s) {
                    int i4 = i3 + 1;
                    instance3.setCertificateEntry(Integer.toString(i3), (X509Certificate) instance.generateCertificate(new Buffer().write(ByteString.decodeBase64(decodeBase64)).inputStream()));
                    i3 = i4;
                }
                ...
                PinnedAmplitudeClient.logger.e(PinnedAmplitudeClient.TAG, e3.getMessage(), e3);
                return null;
            } catch (IOException e4) {
                PinnedAmplitudeClient.logger.e(PinnedAmplitudeClient.TAG, e4.getMessage(), e4);
                return null;
            }
        }
    }
            ...
            public void run() {
                if (!this.initializedSSLSocketFactory) {
                    ...
                    if (pinnedCertSslSocketFactory != null) {
                        this.httpClient = new OkHttpClient.Builder().sslSocketFactory(pinnedCertSslSocketFactory).build();
                    } else {
