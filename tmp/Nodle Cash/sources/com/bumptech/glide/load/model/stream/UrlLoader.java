...
public class UrlLoader implements ModelLoader<URL, InputStream> {
    ...
    public ModelLoader.LoadData<InputStream> buildLoadData(@NonNull URL url, int i3, int i4, @NonNull Options options) {
        return this.glideUrlLoader.buildLoadData(new GlideUrl(url), i3, i4, options);
    }
}
