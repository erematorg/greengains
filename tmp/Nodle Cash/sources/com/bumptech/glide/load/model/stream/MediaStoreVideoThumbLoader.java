...
public class MediaStoreVideoThumbLoader implements ModelLoader<Uri, InputStream> {
    ...
    @Nullable
    public ModelLoader.LoadData<InputStream> buildLoadData(@NonNull Uri uri, int i3, int i4, @NonNull Options options) {
        if (!MediaStoreUtil.isThumbnailSize(i3, i4) || !isRequestingDefaultFrame(options)) {
            return null;
        }
