...
public class UriLoader<Data> implements ModelLoader<Uri, Data> {
    private static final Set<String> SCHEMES = Collections.unmodifiableSet(new HashSet(Arrays.asList(new String[]{StringLookupFactory.KEY_FILE, FirebaseAnalytics.Param.CONTENT, "android.resource"})));
