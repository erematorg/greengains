...
public class BitmapDrawableDecoder<DataType> implements ResourceDecoder<DataType, BitmapDrawable> {
    ...
    public Resource<BitmapDrawable> decode(@NonNull DataType datatype, int i3, int i4, @NonNull Options options) throws IOException {
        return LazyBitmapDrawableResource.obtain(this.resources, this.decoder.decode(datatype, i3, i4, options));
    }
