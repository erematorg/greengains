...
class GifFrameLoader {
    ...
    public static class DelayTarget extends CustomTarget<Bitmap> {
        ...
        public DelayTarget(Handler handler2, int i3, long j2) {
    ...
    public GifFrameLoader(Glide glide, GifDecoder gifDecoder2, int i3, int i4, Transformation<Bitmap> transformation2, Bitmap bitmap) {
        this(glide.getBitmapPool(), Glide.with(glide.getContext()), gifDecoder2, (Handler) null, getRequestBuilder(Glide.with(glide.getContext()), i3, i4), transformation2, bitmap);
    }
    ...
    private static RequestBuilder<Bitmap> getRequestBuilder(RequestManager requestManager2, int i3, int i4) {
        return requestManager2.asBitmap().apply((BaseRequestOptions<?>) ((RequestOptions) ((RequestOptions) RequestOptions.diskCacheStrategyOf(DiskCacheStrategy.NONE).useAnimationPool(true)).skipMemoryCache(true)).override(i3, i4));
    }
