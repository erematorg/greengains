...
public class StreamGifDecoder implements ResourceDecoder<InputStream, GifDrawable> {
    ...
    public Resource<GifDrawable> decode(@NonNull InputStream inputStream, int i3, int i4, @NonNull Options options) throws IOException {
        byte[] inputStreamToBytes = inputStreamToBytes(inputStream);
        if (inputStreamToBytes == null) {
            return null;
        }
        return this.byteBufferDecoder.decode(ByteBuffer.wrap(inputStreamToBytes), i3, i4, options);
    }
