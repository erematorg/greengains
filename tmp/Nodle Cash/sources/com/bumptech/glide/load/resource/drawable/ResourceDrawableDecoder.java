...
public class ResourceDrawableDecoder implements ResourceDecoder<Uri, Drawable> {
    ...
    private Context findContextForPackage(Uri uri, @NonNull String str) {
        ...
        try {
            ...
            throw new IllegalArgumentException(a.l("Failed to obtain context or unrecognized Uri format for: ", uri), e3);
        }
    }
    ...
    private int findResourceIdFromResourceIdUri(Uri uri) {
        try {
            ...
            throw new IllegalArgumentException(a.l("Unrecognized Uri format: ", uri), e3);
        }
    }
    ...
    private int findResourceIdFromTypeAndNameResourceUri(Context context2, Uri uri) {
        ...
        throw new IllegalArgumentException(a.l("Failed to find resource id for: ", uri));
    }
    ...
    private int findResourceIdFromUri(Context context2, Uri uri) {
        ...
        throw new IllegalArgumentException(a.l("Unrecognized Uri format: ", uri));
    }

    @Nullable
    public Resource<Drawable> decode(@NonNull Uri uri, int i3, int i4, @NonNull Options options) {
        Drawable drawable;
        String authority = uri.getAuthority();
