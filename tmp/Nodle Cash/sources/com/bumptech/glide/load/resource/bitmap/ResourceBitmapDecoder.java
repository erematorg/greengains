...
public class ResourceBitmapDecoder implements ResourceDecoder<Uri, Bitmap> {
    ...
    @Nullable
    public Resource<Bitmap> decode(@NonNull Uri uri, int i3, int i4, @NonNull Options options) {
        Resource<Drawable> decode = this.drawableDecoder.decode(uri, i3, i4, options);
        if (decode == null) {
            return null;
        }
        return DrawableToBitmapConverter.convert(this.bitmapPool, decode.get(), i3, i4);
    }
