...
final class DrawableToBitmapConverter {
    ...
    @Nullable
    public static Resource<Bitmap> convert(BitmapPool bitmapPool, Drawable drawable, int i3, int i4) {
        Bitmap bitmap;
        ...
        if (current instanceof BitmapDrawable) {
            ...
            bitmap = drawToBitmap(bitmapPool, current, i3, i4);
            z2 = true;
        } else {
            bitmap = null;
        }
    ...
    @Nullable
    private static Bitmap drawToBitmap(BitmapPool bitmapPool, Drawable drawable, int i3, int i4) {
        if (i3 == Integer.MIN_VALUE && drawable.getIntrinsicWidth() <= 0) {
            ...
            return null;
        } else if (i4 != Integer.MIN_VALUE || drawable.getIntrinsicHeight() > 0) {
            ...
            Bitmap bitmap = bitmapPool.get(i3, i4, Bitmap.Config.ARGB_8888);
            try {
