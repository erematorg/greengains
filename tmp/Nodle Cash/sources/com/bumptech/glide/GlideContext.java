...
public class GlideContext extends ContextWrapper {
    ...
    public GlideContext(@NonNull Context context, @NonNull ArrayPool arrayPool2, @NonNull GlideSuppliers.GlideSupplier<Registry> glideSupplier, @NonNull ImageViewTargetFactory imageViewTargetFactory2, @NonNull Glide.RequestOptionsFactory requestOptionsFactory, @NonNull Map<Class<?>, TransitionOptions<?, ?>> map, @NonNull List<RequestListener<Object>> list, @NonNull Engine engine2, @NonNull GlideExperiments glideExperiments, int i3) {
