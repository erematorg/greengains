...
public class LoadPathCache {
    ...
    static {
        ...
        NO_PATHS_SIGNAL = new LoadPath(cls, cls2, cls3, Collections.singletonList(new DecodePath(Object.class, Object.class, Object.class, Collections.emptyList(), new UnitTranscoder(), (Pools.Pool<List<Throwable>>) null)), (Pools.Pool<List<Throwable>>) null);
    }
