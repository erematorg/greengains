...
public abstract class CustomViewTarget<T extends View, Z> implements Target<Z> {
    ...
    public static final class SizeDeterminer {
        ...
        private int getTargetDimen(int i3, int i4, int i5) {
            int i6 = i4 - i5;
            if (i6 > 0) {
                return i6;
            }
            ...
            if (this.view.isLayoutRequested() || i4 != -2) {
                return 0;
            }
        ...
        private boolean isViewStateAndSizeValid(int i3, int i4) {
            return isDimensionValid(i3) && isDimensionValid(i4);
        }

        private void notifyCbs(int i3, int i4) {
    ...
    @Deprecated
    public final CustomViewTarget<T, Z> useTagId(@IdRes int i3) {
        return this;
    }
