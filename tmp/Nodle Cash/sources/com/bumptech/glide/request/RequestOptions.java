...
public class RequestOptions extends BaseRequestOptions<RequestOptions> {
    ...
    @CheckResult
    @NonNull
    public static RequestOptions encodeQualityOf(@IntRange(from = 0, to = 100) int i3) {
        return (RequestOptions) new RequestOptions().encodeQuality(i3);
    }
    ...
    public static RequestOptions frameOf(@IntRange(from = 0) long j2) {
        return (RequestOptions) new RequestOptions().frame(j2);
    }
    ...
    public static <T> RequestOptions option(@NonNull Option<T> option, @NonNull T t2) {
        return (RequestOptions) new RequestOptions().set(option, t2);
    }

    @CheckResult
    @NonNull
    public static RequestOptions overrideOf(int i3, int i4) {
        return (RequestOptions) new RequestOptions().override(i3, i4);
    }
    ...
    @CheckResult
    @NonNull
    public static RequestOptions timeoutOf(@IntRange(from = 0) int i3) {
        return (RequestOptions) new RequestOptions().timeout(i3);
    }
    ...
    @CheckResult
    @NonNull
    public static RequestOptions errorOf(@DrawableRes int i3) {
        return (RequestOptions) new RequestOptions().error(i3);
    }

    @CheckResult
    @NonNull
    public static RequestOptions overrideOf(int i3) {
        return overrideOf(i3, i3);
    }

    @CheckResult
    @NonNull
    public static RequestOptions placeholderOf(@DrawableRes int i3) {
        return (RequestOptions) new RequestOptions().placeholder(i3);
    }
}
