...
public class RequestManagerRetriever implements Handler.Callback {
    ...
    private static FrameWaiter buildFrameWaiter() {
        return (!HardwareConfigState.HARDWARE_BITMAPS_SUPPORTED || !HardwareConfigState.BLOCK_HARDWARE_BITMAPS_WHEN_GL_CONTEXT_MIGHT_NOT_BE_INITIALIZED) ? new DoNothingFirstFrameWaiter() : new FirstFrameWaiter();
    }
