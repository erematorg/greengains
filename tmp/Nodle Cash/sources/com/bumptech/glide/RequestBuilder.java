...
public class RequestBuilder<TranscodeType> extends BaseRequestOptions<RequestBuilder<TranscodeType>> implements Cloneable, ModelTypes<RequestBuilder<TranscodeType>> {
    ...
    private Request buildRequestRecursive(Object obj, Target<TranscodeType> target, @Nullable RequestListener<TranscodeType> requestListener, @Nullable RequestCoordinator requestCoordinator, TransitionOptions<?, ? super TranscodeType> transitionOptions2, Priority priority, int i3, int i4, BaseRequestOptions<?> baseRequestOptions, Executor executor) {
        ...
        Request buildThumbnailRequestRecursive = buildThumbnailRequestRecursive(obj, target, requestListener, errorRequestCoordinator2, transitionOptions2, priority, i3, i4, baseRequestOptions, executor);
        if (errorRequestCoordinator == null) {
            return buildThumbnailRequestRecursive;
        }
        int overrideWidth = this.errorBuilder.getOverrideWidth();
        int overrideHeight = this.errorBuilder.getOverrideHeight();
        if (Util.isValidDimensions(i3, i4) && !this.errorBuilder.isValidOverride()) {
    ...
    private Priority getThumbnailPriority(@NonNull Priority priority) {
        int i3 = AnonymousClass1.$SwitchMap$com$bumptech$glide$Priority[priority.ordinal()];
        if (i3 == 1) {
    ...
    private Request obtainRequest(Object obj, Target<TranscodeType> target, RequestListener<TranscodeType> requestListener, BaseRequestOptions<?> baseRequestOptions, RequestCoordinator requestCoordinator, TransitionOptions<?, ? super TranscodeType> transitionOptions2, Priority priority, int i3, int i4, Executor executor) {
        Context context2 = this.context;
        GlideContext glideContext2 = this.glideContext;
        return SingleRequest.obtain(context2, glideContext2, obj, this.model, this.transcodeClass, baseRequestOptions, i3, i4, priority, target, requestListener, this.requestListeners, requestCoordinator, glideContext2.getEngine(), transitionOptions2.getTransitionFactory(), executor);
    }
    ...
    public <Y extends Target<File>> Y downloadOnly(@NonNull Y y2) {
        return getDownloadOnlyRequest().into(y2);
    }
    ...
    public <Y extends Target<TranscodeType>> Y into(@NonNull Y y2) {
        return into(y2, (RequestListener) null, Executors.mainThreadExecutor());
    }
    ...
    @NonNull
    public Target<TranscodeType> preload(int i3, int i4) {
        return into(PreloadTarget.obtain(this.requestManager, i3, i4));
    }
    ...
    @CheckResult
    @Deprecated
    public FutureTarget<File> downloadOnly(int i3, int i4) {
    ...
    public <Y extends Target<TranscodeType>> Y into(@NonNull Y y2, @Nullable RequestListener<TranscodeType> requestListener, Executor executor) {
        return into(y2, requestListener, this, executor);
    }

    @NonNull
    public FutureTarget<TranscodeType> submit(int i3, int i4) {
    ...
    private <Y extends Target<TranscodeType>> Y into(@NonNull Y y2, @Nullable RequestListener<TranscodeType> requestListener, BaseRequestOptions<?> baseRequestOptions, Executor executor) {
        ...
        if (this.isModelSet) {
            Request buildRequest = buildRequest(y2, requestListener, baseRequestOptions, executor);
    ...
    @Deprecated
    public FutureTarget<TranscodeType> into(int i3, int i4) {
        return submit(i3, i4);
    }
}
